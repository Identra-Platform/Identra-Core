(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).vb = function () {
    return this.ub_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.ub_1[index];
  };
  ...
  protoOf(AtomicRef).wb = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).xb = function () {
  ...
  protoOf(AtomicBoolean).yb = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).xb = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).zb = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).xb = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).atomicfu$getAndIncrement$long = function () {
    ...
    this.kotlinx$atomicfu$value = _unary__edvuaz.d2();
  ...
  protoOf(AtomicLong).atomicfu$getAndAdd$long = function (delta) {
    var oldValue = this.kotlinx$atomicfu$value;
    this.kotlinx$atomicfu$value = this.kotlinx$atomicfu$value.y1(delta);
    return oldValue;
  };
  ...
  protoOf(AtomicLong).atomicfu$incrementAndGet$long = function () {
    this.kotlinx$atomicfu$value = this.kotlinx$atomicfu$value.d2();
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).ac = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).xb = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).vb);
  //endregion
