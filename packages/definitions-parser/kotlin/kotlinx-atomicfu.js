(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).rr = function () {
    return this.qr_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.qr_1[index];
  };
  ...
  protoOf(AtomicRef).sr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).tr = function () {
  ...
  protoOf(AtomicBoolean).ur = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).tr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).tr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).rr);
  //endregion
