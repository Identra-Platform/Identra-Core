(function (factory) {
  ...
  function Companion_0() {
    ...
    tmp.a3d_1 = ensureNotNull(tmp$ret$0).z3c_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.a3d_1 + 1 | 0;
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().c3d_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.d3d_1 = fin;
    this.e3d_1 = frameType;
    this.f3d_1 = data;
    this.g3d_1 = disposableHandle;
    this.h3d_1 = rsv1;
    this.i3d_1 = rsv2;
    this.j3d_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.e3d_1.toString() + ' (fin=' + this.d3d_1 + ', buffer len = ' + this.f3d_1.length + ')';
  };
  //region block: init
