(function (factory) {
  ...
  function KotlinxSerializer$Companion$DefaultJson$lambda($this$Json) {
    ...
    $this$Json.x4q_1 = false;
    $this$Json.j4r_1 = true;
    $this$Json.l4r_1 = false;
    return Unit_instance;
  }
  function Companion() {
    Companion_instance = this;
    var tmp = this;
    tmp.y53_1 = Json(VOID, KotlinxSerializer$Companion$DefaultJson$lambda);
  }
  ...
  function KotlinxSerializer(json) {
    ...
    json = json === VOID ? Companion_getInstance().y53_1 : json;
    this.z53_1 = json;
  }
  var initializer;
