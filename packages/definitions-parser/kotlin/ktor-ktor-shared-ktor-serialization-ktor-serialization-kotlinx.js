(function (factory) {
  ...
  function serializeContent($this, serializer, format, value, contentType, charset) {
    ...
    if (isInterface(format, StringFormat)) {
      var content = format.w1z(isInterface(serializer, KSerializer) ? serializer : THROW_CCE(), value);
      tmp = new TextContent(content, withCharsetIfNeeded(contentType, charset));
    } else {
      if (isInterface(format, BinaryFormat)) {
        var content_0 = format.y1z(isInterface(serializer, KSerializer) ? serializer : THROW_CCE(), value);
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (isInterface(tmp0_subject, StringFormat)) {
              tmp_2 = this.s58_1.i58_1.x1z(this.x58_1, readText(contentPacket, this.t58_1));
            } else {
              if (isInterface(tmp0_subject, BinaryFormat)) {
                tmp_2 = this.s58_1.i58_1.z1z(this.x58_1, readByteArray(contentPacket));
              } else {
