      ...
      try {
        ...
        switch (tmp) {
          ...
          case 3:
            ...
            tmp_9.wak_1 = tmp3.x1z(isInterface(this_2, KSerializer) ? this_2 : THROW_CCE(), string);
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            return this_1.x1z(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), it);
          case 3:
            throw this.p9_1;
        }
      } catch ($p) {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (tmp3_elvis_lhs == null) {
              ...
              tmp_12 = tmp0.x1z(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), string);
            } else {
            ...
            while (_iterator__ex2g4s.q()) {
              ...
              try {
                ...
                l$ret$1: do {
                  ...
                  tmp$ret$0 = this_1.w1z(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), publicKeyJwk);
                }
                 while (false);
                var value = tmp$ret$0;
                tmp_7 = _Result___init__impl__xyqfz8(value);
