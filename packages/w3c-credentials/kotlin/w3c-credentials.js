(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof globalThis['kotlinx-serialization-kotlinx-serialization-core'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'kotlinx-serialization-kotlinx-serialization-core' was not found. Please, check whether 'kotlinx-serialization-kotlinx-serialization-core' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['kotlin-kotlin-stdlib'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'kotlin-kotlin-stdlib' was not found. Please, check whether 'kotlin-kotlin-stdlib' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof crypto === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'crypto' was not found. Please, check whether 'crypto' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['Kotlin-DateTime-library-kotlinx-datetime'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'Kotlin-DateTime-library-kotlinx-datetime' was not found. Please, check whether 'Kotlin-DateTime-library-kotlinx-datetime' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['kotlinx-serialization-kotlinx-serialization-json'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'kotlinx-serialization-kotlinx-serialization-json' was not found. Please, check whether 'kotlinx-serialization-kotlinx-serialization-json' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof dids === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'dids' was not found. Please, check whether 'dids' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['kotlin-suspend-transform-compiler-plugin-runtime-suspend-transform-runtime'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'kotlin-suspend-transform-compiler-plugin-runtime-suspend-transform-runtime' was not found. Please, check whether 'kotlin-suspend-transform-compiler-plugin-runtime-suspend-transform-runtime' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['ktor-ktor-client-ktor-client-core'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'ktor-ktor-client-ktor-client-core' was not found. Please, check whether 'ktor-ktor-client-ktor-client-core' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['ktor-ktor-http'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'ktor-ktor-http' was not found. Please, check whether 'ktor-ktor-http' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['waltid-identity-waltid-libraries-sdjwt-waltid-sdjwt'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'waltid-identity-waltid-libraries-sdjwt-waltid-sdjwt' was not found. Please, check whether 'waltid-identity-waltid-libraries-sdjwt-waltid-sdjwt' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['kotlin-logging'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'kotlin-logging' was not found. Please, check whether 'kotlin-logging' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    if (typeof globalThis['ktor-ktor-io'] === 'undefined') {
      throw new Error("Error loading module 'id.walt.credentials:waltid-w3c-credentials'. Its dependency 'ktor-ktor-io' was not found. Please, check whether 'ktor-ktor-io' is loaded prior to 'id.walt.credentials:waltid-w3c-credentials'.");
    }
    globalThis['id.walt.credentials:waltid-w3c-credentials'] = factory(typeof globalThis['id.walt.credentials:waltid-w3c-credentials'] === 'undefined' ? {} : globalThis['id.walt.credentials:waltid-w3c-credentials'], globalThis['kotlinx-serialization-kotlinx-serialization-core'], globalThis['kotlin-kotlin-stdlib'], crypto, globalThis['Kotlin-DateTime-library-kotlinx-datetime'], globalThis['kotlinx-serialization-kotlinx-serialization-json'], dids, globalThis['kotlinx-coroutines-core'], globalThis['kotlin-suspend-transform-compiler-plugin-runtime-suspend-transform-runtime'], globalThis['ktor-ktor-client-ktor-client-core'], globalThis['ktor-ktor-http'], globalThis['waltid-identity-waltid-libraries-sdjwt-waltid-sdjwt'], globalThis['kotlin-logging'], globalThis['ktor-ktor-io']);
  }
  ...
  protoOf(Companion_9).fromJson = function (json) {
    ...
    var tmp$ret$1 = isInterface(this_2, KSerializer) ? this_2 : THROW_CCE();
    var tmp$ret$2 = this_0.x1z(tmp$ret$1, json);
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            tmp_4.wd7_1 = toByteArray(tmp3.w1z(isInterface(this_2, KSerializer) ? this_2 : THROW_CCE(), value));
            this.m9_1 = 3;
