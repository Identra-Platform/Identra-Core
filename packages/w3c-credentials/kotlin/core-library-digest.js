(function (factory) {
  ...
  function Digest_init_$Init$(algorithm, blockSize, digestLength, $this) {
    ...
    tmp.p6f_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.n6f_1 = algorithm;
    $this.o6f_1 = digestLength;
    $this.q6f_1 = 0;
    return $this;
  }
  protoOf(Digest).r6f = function () {
    return _Buffer___get_value__impl__xxr8tn(this.p6f_1).length;
  };
  protoOf(Digest).s6f = function () {
    return this.o6f_1;
  };
  protoOf(Digest).t6f = function () {
    return this.n6f_1;
  };
  protoOf(Digest).u6f = function (input) {
    this.v6f(input, 0, input.length);
  };
  protoOf(Digest).w6f = function (input, offset, len) {
  ...
  protoOf(Digest).a6g = function (input) {
    // Inline function 'org.kotlincrypto.core.digest.internal.commonDigest' call
    var this_0 = this.p6f_1;
    // Inline function 'kotlin.contracts.contract' call
    var p2 = input.length;
    this.v6f(input, 0, p2);
    // Inline function 'org.kotlincrypto.core.digest.internal.commonDigest' call
  ...
  protoOf(Digest).b6g = function (dest, destOffset) {
    ...
    this.c6g(dest, destOffset, p2, tmp1);
    // Inline function 'org.kotlincrypto.core.digest.internal.commonReset' call
    // Inline function 'kotlin.contracts.contract' call
    fill(_Buffer___get_value__impl__xxr8tn(tmp0), 0);
    this.q6f_1 = 0;
  ...
  protoOf(Digest).c6g = function (dest, destOffset, buf, bufPos) {
    var result = this.y6f(buf, bufPos);
  ...
  protoOf(Digest).v6f = function (input, offset, len) {
    var tmp0 = this.p6f_1;
    var tmp4 = this.q6f_1;
    $l$block: {
  ...
  protoOf(Digest).equals = function (other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.p6f_1, this.p6f_1);
    } else {
      tmp = false;
    }
    return tmp;
