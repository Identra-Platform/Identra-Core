(function (factory) {
  ...
  var SequenceScope = kotlin_kotlin.$_$.be;
  ...
  var sequence = kotlin_kotlin.$_$.he;
  ...
  var CharSequence = kotlin_kotlin.$_$.ih;
  ...
  var toLongArray = kotlin_kotlin.$_$.ca;
  ...
  protoOf(CIOMultipartDataBase).ds = function () {
    return this.g36_1;
  };
  ...
  protoOf(HeadersData$headersStarts$slambda).x36 = function ($this$sequence, $completion) {
    var tmp = this.y36($this$sequence, $completion);
    tmp.o9_1 = Unit_instance;
    tmp.p9_1 = null;
    return tmp.ea();
  };
  protoOf(HeadersData$headersStarts$slambda).ua = function (p1, $completion) {
    return this.x36(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.v36_1 = this.u36_1.r();
            this.w36_1 = 0;
            this.m9_1 = 2;
            continue $sm;
          case 2:
            if (!(this.w36_1 < this.v36_1.length)) {
              this.m9_1 = 5;
              continue $sm;
            }

            if (!(this.r36_1.a37(this.t36_1 + 0 | 0) === -1)) {
              this.m9_1 = 3;
              suspendResult = this.s36_1.ji(this.t36_1, this);
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            this.w36_1 = this.w36_1 + 6 | 0;
            this.t36_1 = this.t36_1 + 6 | 0;
            this.m9_1 = 2;
            continue $sm;
          case 5:
            this.m9_1 = 1;
  ...
  protoOf(HeadersData$headersStarts$slambda).y36 = function ($this$sequence, completion) {
    var i = new HeadersData$headersStarts$slambda(this.r36_1, completion);
    i.s36_1 = $this$sequence;
    return i;
  };
  function HeadersData$headersStarts$slambda_0(this$0, resultContinuation) {
    ...
    var l = function ($this$sequence, $completion) {
      return i.x36($this$sequence, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  protoOf(HeadersData).b37 = function () {
    return this.z36_1.s();
  };
  protoOf(HeadersData).c37 = function (subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.z36_1.n(get_IntArrayPool().f1y());
      }
       while (inductionVariable < subArraysCount);
  };
  protoOf(HeadersData).a37 = function (index) {
    return this.z36_1.u(index / 768 | 0)[index % 768 | 0];
  };
  protoOf(HeadersData).d37 = function (index, value) {
    this.z36_1.u(index / 768 | 0)[index % 768 | 0] = value;
  };
  protoOf(HeadersData).e37 = function () {
    return sequence(HeadersData$headersStarts$slambda_0(this, null));
  };
  protoOf(HeadersData).h1e = function () {
    var _iterator__ex2g4s = this.z36_1.p();
    while (_iterator__ex2g4s.q()) {
      var array = _iterator__ex2g4s.r();
      get_IntArrayPool().g1y(array);
    }
    this.z36_1.e2();
  };
  ...
  function resize($this) {
    ...
    var this_0 = get_HeadersDataPool().f1y();
    this_0.c37(imul(prevData.b37(), 2) | 1);
    tmp.i37_1 = this_0;
    var _iterator__ex2g4s = prevData.e37().p();
    while (_iterator__ex2g4s.q()) {
      var headerOffset = _iterator__ex2g4s.r();
      $this.j37(prevData.a37(headerOffset + 1 | 0), prevData.a37(headerOffset + 2 | 0), prevData.a37(headerOffset + 3 | 0), prevData.a37(headerOffset + 4 | 0));
    }
    get_HeadersDataPool().g1y(prevData);
  ...
  function headerHasName($this, name, headerOffset) {
    var nameStartIndex = $this.i37_1.a37(headerOffset + 1 | 0);
    var nameEndIndex = $this.i37_1.a37(headerOffset + 2 | 0);
  ...
  function HttpHeadersMap(builder) {
    ...
    this.g37_1 = 0;
    this.h37_1 = 0;
    this.i37_1 = get_HeadersDataPool().f1y();
  }
  protoOf(HttpHeadersMap).ze = function (name) {
    if (this.g37_1 === 0)
      return null;
    ...
    while (!(this.i37_1.a37(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.k37(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.h37_1 | 0;
    }
    return null;
  };
  protoOf(HttpHeadersMap).l37 = function () {
    return this.i37_1.e37();
  };
  protoOf(HttpHeadersMap).j37 = function (nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    ...
    this.i37_1.d37(headerOffset + 0 | 0, hash);
    this.i37_1.d37(headerOffset + 1 | 0, nameStartIndex);
    this.i37_1.d37(headerOffset + 2 | 0, nameEndIndex);
    this.i37_1.d37(headerOffset + 3 | 0, valueStartIndex);
    this.i37_1.d37(headerOffset + 4 | 0, valueEndIndex);
    this.i37_1.d37(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.i37_1.d37(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.g37_1 = this.g37_1 + 1 | 0;
  };
  protoOf(HttpHeadersMap).t37 = function (headerOffset) {
    var nameStartIndex = this.i37_1.a37(headerOffset + 1 | 0);
    var nameEndIndex = this.i37_1.a37(headerOffset + 2 | 0);
    return this.f37_1.c(nameStartIndex, nameEndIndex);
  };
  protoOf(HttpHeadersMap).k37 = function (headerOffset) {
    var valueStartIndex = this.i37_1.a37(headerOffset + 3 | 0);
    var valueEndIndex = this.i37_1.a37(headerOffset + 4 | 0);
    return this.f37_1.c(valueStartIndex, valueEndIndex);
  };
  protoOf(HttpHeadersMap).h1e = function () {
    this.g37_1 = 0;
    this.h37_1 = 0;
    get_HeadersDataPool().g1y(this.i37_1);
    this.i37_1 = get_HeadersDataPool().f1y();
  };
  ...
  function dumpTo(_this__u8e3s4, indent, out) {
    _init_properties_HttpHeadersMap_kt__hwatby();
    var _iterator__ex2g4s = _this__u8e3s4.l37().p();
    while (_iterator__ex2g4s.q()) {
      var offset = _iterator__ex2g4s.r();
      out.o(indent);
      out.o(_this__u8e3s4.t37(offset));
      out.o(' => ');
      out.o(_this__u8e3s4.k37(offset));
      out.o('\n');
    }
  }
  ...
  protoOf(IntArrayPool$1).y1x = function () {
    var tmp = 0;
  ...
  protoOf(IntArrayPool$1).x37 = function (instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).d1y.call(this, instance);
  };
  protoOf(IntArrayPool$1).d1y = function (instance) {
    return this.x37(isIntArray(instance) ? instance : THROW_CCE());
  };
  function HeadersDataPool$1() {
    DefaultPool.call(this, 1000);
  }
  protoOf(HeadersDataPool$1).y1x = function () {
  ...
  protoOf(HeadersDataPool$1).d1y = function (instance) {
  ...
  function parseHeaderName(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var index = range.o38_1;
    var end = range.p38_1;
    while (index < end) {
      var ch = text.b(index);
      if (ch === _Char___init__impl__6a9atx(58) && !(index === range.o38_1)) {
        range.o38_1 = index + 1 | 0;
        return index;
      }
      if (isDelimiter(ch)) {
        parseHeaderNameFailed(text, index, range.o38_1, ch);
      }
      index = index + 1 | 0;
    }
  ...
  function parseHeaderValue(text, range) {
    ...
    range.o38_1 = valueStart;
    range.p38_1 = valueLastIndex + 1 | 0;
  }
  ...
  function noColonFound(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var tmp1 = range.o38_1;
    // Inline function 'kotlin.text.substring' call
    var endIndex = range.p38_1;
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.m9_1 = 2;
            suspendResult = readUTF8LineTo(this.k38_1, this.l38_1, 8192, get_httpLineEndings(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            this.m38_1.p38_1 = this.l38_1.s37_1;
            var rangeLength = this.m38_1.p38_1 - this.m38_1.o38_1 | 0;
            if (rangeLength === 0) {
              this.m9_1 = 5;
              continue $sm;
            } else {
          ...
          case 4:
            ...
            var nameStart = this.m38_1.o38_1;
            var nameEnd = parseHeaderName(this.l38_1, this.m38_1);
            var headerEnd = this.m38_1.p38_1;
            parseHeaderValue(this.l38_1, this.m38_1);
            var valueStart = this.m38_1.o38_1;
            var valueEnd = this.m38_1.p38_1;
            this.m38_1.o38_1 = headerEnd;
            this.n38_1.j37(nameStart, nameEnd, valueStart, valueEnd);
            this.m9_1 = 1;
            continue $sm;
          case 5:
            var host = this.n38_1.ze(HttpHeaders_getInstance().b2x_1);
            if (!(host == null)) {
  ...
  function _init_properties_HttpParser_kt__gbdom1() {
    if (!properties_initialized_HttpParser_kt_uedryv) {
      ...
      httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance().a1r_1, Companion_getInstance().z1q_1);
      versions = Companion_instance.q38(listOf(['HTTP/1.0', 'HTTP/1.1']));
    }
  }
  function get_CrLf() {
  ...
  function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
    ...
    _init_properties_Multipart_kt__ato98a();
    if (!MultiPart_getInstance().r2u(contentType)) {
  ...
  function parseMultipart$slambda$slambda($firstBoundary, $countedInput, resultContinuation) {
    this.q3a_1 = $firstBoundary;
    this.r3a_1 = $countedInput;
    CoroutineImpl.call(this, resultContinuation);
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 3;
            this.m9_1 = 1;
            suspendResult = parsePreambleImpl(this.q3a_1, this.r3a_1, this.s3a_1.d1v_1, new Long(8193, 0), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            this.m9_1 = 2;
            suspendResult = this.s3a_1.d1v_1.e1n(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda$slambda).u3a = function ($this$writer, completion) {
    var i = new parseMultipart$slambda$slambda(this.q3a_1, this.r3a_1, completion);
    i.s3a_1 = $this$writer;
    return i;
  };
  ...
  function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    this.d3b_1 = $input;
    this.e3b_1 = $boundaryPrefixed;
    this.f3b_1 = $maxPartSize;
    this.g3b_1 = $totalLength;
    CoroutineImpl.call(this, resultContinuation);
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 23;
            this.i3b_1 = counted(this.d3b_1);
            this.j3b_1 = this.i3b_1.m1x();
            this.k3b_1 = this.e3b_1.g1h(get_PrefixString().s());
            this.m9_1 = 1;
            suspendResult = readRemaining(writer(this.h3b_1, VOID, VOID, parseMultipart$slambda$slambda_0(this.k3b_1, this.i3b_1, null)).b1v_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            ...
            if (get_remaining(this.l3b_1).e1(new Long(0, 0)) > 0) {
              this.m9_1 = 2;
              suspendResult = this.h3b_1.h19(new Preamble(this.l3b_1), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            if (!this.i3b_1.b1n()) {
              this.m9_1 = 5;
              suspendResult = skipIfFound(this.i3b_1, get_PrefixString(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 6:
            ...
            this.m9_1 = 7;
            suspendResult = skipIfFound(this.i3b_1, get_CrLf(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 7:
            this.o3b_1 = new ByteChannel();
            this.p3b_1 = CompletableDeferred();
            this.q3b_1 = new MultipartPart(this.p3b_1, this.o3b_1);
            this.m9_1 = 8;
            suspendResult = this.h3b_1.h19(this.q3b_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 8:
            ...
            this.n9_1 = 12;
            this.m9_1 = 9;
            suspendResult = parsePartHeadersImpl(this.i3b_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 9:
            ...
            if (!this.p3b_1.xz(this.r3b_1)) {
              this.r3b_1.h1e();
              throw CancellationException_init_$Create$('Multipart processing has been cancelled');
            }

            this.m9_1 = 10;
            suspendResult = parsePartBodyImpl(this.e3b_1, this.i3b_1, this.o3b_1, this.r3b_1, this.f3b_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 12:
            ...
            var tmp_0 = this.p9_1;
            if (tmp_0 instanceof Error) {
              this.s3b_1 = this.p9_1;
              if (this.p3b_1.zz(this.s3b_1)) {
                var tmp0_safe_receiver = this.r3b_1;
                if (tmp0_safe_receiver == null)
                  null;
                else {
                  tmp0_safe_receiver.h1e();
                }
              }
              close(this.o3b_1, this.s3b_1);
              throw this.s3b_1;
            } else {
              throw this.p9_1;
            }
          ...
          case 15:
            if (!(this.g3b_1 == null)) {
              this.t3b_1 = this.i3b_1.m1x().a3(this.j3b_1);
              this.u3b_1 = this.g3b_1.a3(this.t3b_1);
              if (this.u3b_1.e1(new Long(2147483647, 0)) > 0)
                throw IOException_init_$Create$('Failed to parse multipart: prologue is too long');
              if (this.u3b_1.e1(new Long(0, 0)) > 0) {
                this.m9_1 = 19;
                suspendResult = readPacket(this.i3b_1, this.u3b_1.j1(), this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
              ...
              this.m9_1 = 16;
              suspendResult = readRemaining(this.i3b_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 16:
            ...
            if (!this.v3b_1.o1h()) {
              this.m9_1 = 17;
              suspendResult = this.h3b_1.h19(new Epilogue(this.v3b_1), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 19:
            ...
            this.x3b_1 = new Epilogue(this.w3b_1);
            this.m9_1 = 20;
            suspendResult = this.h3b_1.h19(this.x3b_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda).z3b = function ($this$produce, completion) {
    var i = new parseMultipart$slambda(this.d3b_1, this.e3b_1, this.f3b_1, this.g3b_1, completion);
    i.h3b_1 = $this$produce;
    return i;
  };
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 3;
            this.e39_1 = new CharArrayBuilder();
            this.n9_1 = 2;
            this.m9_1 = 1;
            suspendResult = parseHeaders(this.d39_1, this.e39_1, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 6;
            var tmp_0 = this;
            var tmp0_safe_receiver = this.q39_1.ze('Content-Length');
            tmp_0.s39_1 = tmp0_safe_receiver == null ? null : parseDecLong(tmp0_safe_receiver);
            if (this.s39_1 == null) {
              this.m9_1 = 3;
              suspendResult = readUntil(this.o39_1, this.n39_1, this.p39_1, this.r39_1, true, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              if ((new Long(0, 0)).i3(this.r39_1).yl(this.s39_1)) {
                this.m9_1 = 1;
                suspendResult = copyTo(this.o39_1, this.p39_1, this.s39_1, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
                ...
                var tmp_1 = this;
                throwLimitExceeded(this.s39_1, this.r39_1);
              }
            }
          ...
          case 1:
            ...
            this.m9_1 = 2;
            suspendResult = skipIfFoundReadCount(this.o39_1, this.n39_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            ...
            this.t39_1 = this.u39_1.z2(this.v39_1);
            this.m9_1 = 4;
            continue $sm;
          case 3:
            ...
            continue $sm;
          case 4:
            this.w39_1 = this.t39_1;
            this.m9_1 = 5;
            suspendResult = this.p39_1.t1m(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 3;
            this.m9_1 = 1;
            suspendResult = skipIfFound(this.f3a_1, this.g3a_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            if (suspendResult) {
              var tmp_0 = this;
              tmp_0.h3a_1 = toLong(this.g3a_1.s());
              this.m9_1 = 2;
              continue $sm;
            } else {
              var tmp_1 = this;
              tmp_1.h3a_1 = new Long(0, 0);
              this.m9_1 = 2;
              continue $sm;
            }
  ...
  protoOf(Companion).q38 = function (from) {
  ...
  function getImpl($this, index) {
    return bufferForIndex($this, index)[index % ensureNotNull($this.o37_1).length | 0];
  }
  ...
  function bufferForIndex($this, index) {
    ...
    return list.u(index / ensureNotNull($this.o37_1).length | 0);
  }
  ...
  function nonFullBuffer($this) {
    return $this.r37_1 === 0 ? appendNewArray($this) : ensureNotNull($this.o37_1);
  }
  function appendNewArray($this) {
    var newBuffer = $this.m37_1.f1y();
    var existing = $this.o37_1;
    $this.o37_1 = newBuffer;
    $this.r37_1 = newBuffer.length;
    $this.q37_1 = false;
    if (!(existing == null)) {
      var tmp0_elvis_lhs = $this.n37_1;
      var tmp;
      if (tmp0_elvis_lhs == null) {
        // Inline function 'kotlin.also' call
  ...
  function currentPosition($this) {
    return ensureNotNull($this.o37_1).length - $this.r37_1 | 0;
  }
  ...
  protoOf(CharArrayBuilder).b = function (index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.s37_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.s37_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  ...
  protoOf(CharArrayBuilder).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.s37_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.s37_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    return new SubSequenceImpl(this, startIndex, endIndex);
  };
  protoOf(CharArrayBuilder).toString = function () {
    var tmp0_elvis_lhs = this.p37_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.s37_1));
      this.p37_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(CharArrayBuilder).equals = function (other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.s37_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.s37_1);
  };
  protoOf(CharArrayBuilder).hashCode = function () {
    var tmp0_safe_receiver = this.p37_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.s37_1) : tmp1_elvis_lhs;
  };
  protoOf(CharArrayBuilder).y8 = function (value) {
    nonFullBuffer(this)[ensureNotNull(this.o37_1).length - this.r37_1 | 0] = value;
    this.p37_1 = null;
    this.r37_1 = this.r37_1 - 1 | 0;
    this.s37_1 = this.s37_1 + 1 | 0;
    return this;
  };
  protoOf(CharArrayBuilder).wd = function (value, startIndex, endIndex) {
    if (value == null)
      return this;
    var current = startIndex;
    while (current < endIndex) {
      var buffer = nonFullBuffer(this);
      var offset = buffer.length - this.r37_1 | 0;
      ...
      this.r37_1 = this.r37_1 - bytesToCopy | 0;
    }
    this.p37_1 = null;
    this.s37_1 = this.s37_1 + (endIndex - startIndex | 0) | 0;
    return this;
  };
  protoOf(CharArrayBuilder).o = function (value) {
    if (value == null)
      return this;
    return this.wd(value, 0, charSequenceLength(value));
  };
  protoOf(CharArrayBuilder).h1e = function () {
    var list = this.n37_1;
    if (!(list == null)) {
      this.o37_1 = null;
      var inductionVariable = 0;
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.m37_1.g1y(tmp0_safe_receiver);
      }
      this.o37_1 = null;
    }
    this.q37_1 = true;
  ...
  protoOf(CharArrayPool$1).f1y = function () {
    return charArray(2048);
  };
  function CharArrayPool$2() {
    DefaultPool.call(this, 4096);
  }
  protoOf(CharArrayPool$2).y1x = function () {
    return charArray(2048);
  };
  ...
  function DefaultHttpMethods$lambda(it) {
    _init_properties_Chars_kt__d3i39x();
    return it.j30_1.length;
  }
  function DefaultHttpMethods$lambda_0(m, idx) {
    _init_properties_Chars_kt__d3i39x();
    return new Char(charSequenceGet(m.j30_1, idx));
  }
  ...
  function _init_properties_Chars_kt__d3i39x() {
    if (!properties_initialized_Chars_kt_phjfhp) {
      ...
      var tmp_0 = Companion_getInstance_0().i30_1;
  ...
  protoOf(MutableRange).toString = function () {
    return 'MutableRange(start=' + this.o38_1 + ', end=' + this.p38_1 + ')';
  };
