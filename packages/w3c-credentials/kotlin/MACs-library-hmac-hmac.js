(function (factory) {
  ...
  function Engine_init_$Init$_0(key, digest, $this) {
    ...
    Engine_0.call($this);
    $this.x6h_1 = digest;
    $this.v6h_1 = new Int8Array(digest.r6f());
    $this.w6h_1 = new Int8Array(digest.r6f());
    var tmp1 = $this.x6h_1;
    var tmp3 = $this.v6h_1;
    // Inline function 'org.kotlincrypto.macs.hmac.Engine.doInitialization' call
    var oKey = $this.w6h_1;
    var blockSize = tmp1.r6f();
    if (false) {
      tmp1.d6g();
    }
    var tmp;
    if (key.length > blockSize) {
      var keyHash = tmp1.a6g(key);
  ...
  protoOf(Engine_0).w6f = function (input, offset, len) {
    this.x6h_1.w6f(input, offset, len);
  };
  protoOf(Engine_0).r6h = function () {
    var final = new Int8Array(this.x6h_1.s6f());
    this.a6i(final, 0);
    return final;
  };
  protoOf(Engine_0).a6i = function (dest, destOffset) {
    var inner = this.x6h_1.x6f();
    this.x6h_1.u6f(this.w6h_1);
    this.x6h_1.u6f(inner);
    this.x6h_1.b6g(dest, destOffset);
    this.x6h_1.u6f(this.v6h_1);
  };
  protoOf(Engine_0).d6g = function () {
    this.x6h_1.d6g();
    this.x6h_1.u6f(this.v6h_1);
  };
  function Engine_0() {
