(function (factory) {
  ...
  protoOf(Final).cc = function () {
    return this.l6g_1;
  };
  protoOf(Final).dc = function () {
    return this.m6g_1;
  };
  protoOf(Final).n6g = function () {
    if (this.o6g_1)
      return this;
    return new Final(this.l6g_1 << 3, this.m6g_1 << 3 | (this.l6g_1 >>> 29 | 0), true);
  };
  function Final_0() {
  }
  protoOf(Bit32).p6g = function () {
    this.i6g_1 = this.i6g_1 + this.h6g_1 | 0;
    if (this.i6g_1 === 0) {
      this.j6g_1 = this.j6g_1 + 1 | 0;
    }
  };
  protoOf(Bit32).q6g = function (additional) {
    var lo = this.i6g_1;
    var hi = this.j6g_1;
    var lt0 = lo < 0;
    lo = lo + additional | 0;
  ...
  protoOf(Final_1).hashCode = function () {
    ...
    if (this instanceof Final) {
      result = imul(result, 31) + this.l6g_1 | 0;
      result = imul(result, 31) + this.m6g_1 | 0;
    } else {
    ...
    result = imul(result, 31) + getBooleanHashCode(this.o6g_1) | 0;
    return result;
  };
  protoOf(Final_1).toString = function () {
    var tmp;
    if (this instanceof Final) {
      tmp = 'Counter.Bit32.Final[lo=' + this.l6g_1 + ', hi=' + this.m6g_1 + ']';
    } else {
      if (this instanceof Final_0) {
        tmp = 'Counter.Bit64.Final[lo=' + this.s6g_1.toString() + ', hi=' + this.t6g_1.toString() + ']';
      } else {
  ...
  protoOf(Counter).hashCode = function () {
    return 527 + hashCode(this.u6g_1) | 0;
  };
  protoOf(Counter).toString = function () {
    var tmp;
    if (this instanceof Bit32) {
      tmp = 'Bit32[lo=' + this.i6g_1 + ', hi=' + this.j6g_1 + ', incrementBy=' + this.h6g_1 + ']';
    } else {
      if (this instanceof Bit64) {
        tmp = 'Bit64[lo=' + this.x6g_1.toString() + ', hi=' + this.y6g_1.toString() + ', incrementBy=' + this.w6g_1.toString() + ']';
      } else {
        noWhenBranchMatchedException();
      }
    }
