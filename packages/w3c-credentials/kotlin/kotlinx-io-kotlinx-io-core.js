(function (factory) {
  ...
  var toShort = kotlin_kotlin.$_$.jd;
  ...
  var Exception_init_$Init$_1 = kotlin_kotlin.$_$.v1;
  ...
  function PeekSource(upstream) {
    ...
    var tmp0_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.t1h_1;
    tmp.r1j_1 = tmp0_elvis_lhs == null ? -1 : tmp0_elvis_lhs;
    this.s1j_1 = false;
  ...
  protoOf(PeekSource).w4 = function () {
    this.s1j_1 = true;
  };
  ...
  protoOf(RealSource).w4 = function () {
    if (this.v1j_1)
      return Unit_instance;
    this.v1j_1 = true;
    this.u1j_1.w4();
  ...
  protoOf(Segment).c1j = function () {
    var tmp1_safe_receiver = this.v1h_1;
    var tmp0_elvis_lhs = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.a1k();
