(function (factory) {
  ...
  protoOf(AbstractRandom).dl = function (bitCount) {
    var numBytes = (bitCount + 7 | 0) / 8 | 0;
    var b = this.il(numBytes);
    var next = 0;
  ...
  protoOf(AbstractRandom).fl = function (array) {
  ...
  function Default() {
    ...
    CryptographyRandom.call(this);
    this.kc1_1 = defaultCryptographyRandom();
  }
  protoOf(Default).dl = function (bitCount) {
    return this.kc1_1.dl(bitCount);
  };
  protoOf(Default).fi = function () {
    return this.kc1_1.fi();
  };
  protoOf(Default).el = function () {
    return this.kc1_1.el();
  };
  protoOf(Default).fl = function (array) {
    return this.kc1_1.fl(array);
  };
  protoOf(Default).il = function (size) {
    return this.kc1_1.il(size);
  };
  protoOf(Default).gl = function (array, fromIndex, toIndex) {
    return this.kc1_1.gl(array, fromIndex, toIndex);
  };
  ...
  function fillBytes($this, jsArray) {
    ...
    if (size <= 65536) {
      $this.mc1_1.getRandomValues(jsArray);
    } else {
      var filled = 0;
      do {
        ...
        $this.mc1_1.getRandomValues(jsArray.subarray(filled, filled + chunkSize | 0));
  ...
  function WebCryptoCryptographyRandom() {
    ...
    this.lc1_1 = 65536;
    this.mc1_1 = getCrypto();
  }
  protoOf(WebCryptoCryptographyRandom).jc1 = function (array) {
