(function (factory) {
  ...
  function IsoMutableCollection$iterator$lambda(this$0) {
    return function (it) {
      return new IsoMutableIterator(this$0.g6a(it.p()));
    };
  }
  ...
  protoOf(IsoMutableCollection).equals = function (other) {
    return this.h6a(IsoMutableCollection$equals$lambda(other));
  };
  protoOf(IsoMutableCollection).hashCode = function () {
    return this.h6a(IsoMutableCollection$hashCode$lambda);
  };
  protoOf(IsoMutableCollection).s = function () {
    return this.h6a(IsoMutableCollection$_get_size_$lambda_ojq7a4);
  };
  protoOf(IsoMutableCollection).th = function (element) {
    return this.h6a(IsoMutableCollection$contains$lambda(element));
  };
  ...
  protoOf(IsoMutableCollection).uh = function (elements) {
    return this.h6a(IsoMutableCollection$containsAll$lambda(elements));
  };
  protoOf(IsoMutableCollection).y1 = function (elements) {
    return this.uh(elements);
  };
  protoOf(IsoMutableCollection).h = function () {
    return this.h6a(IsoMutableCollection$isEmpty$lambda);
  };
  protoOf(IsoMutableCollection).j6a = function (element) {
    return this.h6a(IsoMutableCollection$add$lambda(element));
  };
  protoOf(IsoMutableCollection).n = function (element) {
    return this.j6a((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  protoOf(IsoMutableCollection).k6a = function (elements) {
    return this.h6a(IsoMutableCollection$addAll$lambda(elements));
  };
  protoOf(IsoMutableCollection).t = function (elements) {
    return this.k6a(elements);
  };
  protoOf(IsoMutableCollection).e2 = function () {
    return this.h6a(IsoMutableCollection$clear$lambda);
  };
  protoOf(IsoMutableCollection).p = function () {
    return this.h6a(IsoMutableCollection$iterator$lambda(this));
  };
  protoOf(IsoMutableCollection).l6a = function (element) {
    return this.h6a(IsoMutableCollection$remove$lambda(element));
  };
  protoOf(IsoMutableCollection).d2 = function (element) {
    if (!(element == null ? true : !(element == null)))
      return false;
    return this.l6a((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  ...
  protoOf(IsoMutableIterator).q = function () {
    return this.h6a(IsoMutableIterator$hasNext$lambda);
  };
  protoOf(IsoMutableIterator).r = function () {
    return this.h6a(IsoMutableIterator$next$lambda);
  };
  protoOf(IsoMutableIterator).s4 = function () {
    return this.h6a(IsoMutableIterator$remove$lambda);
  };
  ...
  function IsoMutableMap$_get_keys_$lambda_z6b79x(this$0) {
    return function (it) {
      return new IsoMutableSet(this$0.g6a(it.l2()));
    };
  }
  function IsoMutableMap$_get_values_$lambda_waxbzb(this$0) {
    return function (it) {
      return new IsoMutableCollection(this$0.g6a(it.m2()));
    };
  }
  ...
  protoOf(IsoMutableMap).s = function () {
    return this.h6a(IsoMutableMap$_get_size_$lambda_5ut66g);
  };
  protoOf(IsoMutableMap).i2 = function (key) {
    return this.h6a(IsoMutableMap$containsKey$lambda(key));
  };
  protoOf(IsoMutableMap).j2 = function (value) {
    return this.h6a(IsoMutableMap$containsValue$lambda(value));
  };
  protoOf(IsoMutableMap).k2 = function (key) {
    return this.h6a(IsoMutableMap$get$lambda(key));
  };
  protoOf(IsoMutableMap).h = function () {
    return this.h6a(IsoMutableMap$isEmpty$lambda);
  };
  ...
  protoOf(IsoMutableMap).l2 = function () {
    return this.h6a(IsoMutableMap$_get_keys_$lambda_z6b79x(this));
  };
  protoOf(IsoMutableMap).m2 = function () {
    return this.h6a(IsoMutableMap$_get_values_$lambda_waxbzb(this));
  };
  protoOf(IsoMutableMap).e2 = function () {
    return this.h6a(IsoMutableMap$clear$lambda);
  };
  protoOf(IsoMutableMap).n2 = function (key, value) {
    return this.h6a(IsoMutableMap$put$lambda(key, value));
  };
  protoOf(IsoMutableMap).p2 = function (from) {
    return this.h6a(IsoMutableMap$putAll$lambda(from));
  };
  protoOf(IsoMutableMap).o2 = function (key) {
    return this.h6a(IsoMutableMap$remove$lambda(key));
  };
  protoOf(IsoMutableMap).equals = function (other) {
    return this.h6a(IsoMutableMap$equals$lambda(other));
  };
  protoOf(IsoMutableMap).hashCode = function () {
    return this.h6a(IsoMutableMap$hashCode$lambda);
  };
