(function (factory) {
  ...
  function Companion() {
    ...
    while (_iterator__ex2g4s.q()) {
      ...
      var tmp$ret$0 = element.c3c_1;
      destination.n2(tmp$ret$0, element);
    }
    tmp.d3c_1 = destination;
    this.e3c_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).f3c = function (code) {
    return this.d3c_1.k2(code);
  };
  ...
  protoOf(CloseReason).i3c = function () {
    return Companion_getInstance().f3c(this.g3c_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.i3c();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.g3c_1 : tmp0_elvis_lhs) + ', message=' + this.h3c_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.g3c_1;
    result = imul(result, 31) + getStringHashCode(this.h3c_1) | 0;
    return result;
  };
  ...
  function Companion_0() {
    ...
    tmp.n3c_1 = ensureNotNull(tmp$ret$0).m3c_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.n3c_1 + 1 | 0;
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    builder.w1i(reason.g3c_1);
    writeText(builder, reason.h3c_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().p3c_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.q3c_1 = fin;
    this.r3c_1 = frameType;
    this.s3c_1 = data;
    this.t3c_1 = disposableHandle;
    this.u3c_1 = rsv1;
    this.v3c_1 = rsv2;
    this.w3c_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.r3c_1.toString() + ' (fin=' + this.q3c_1 + ', buffer len = ' + this.s3c_1.length + ')';
  };
  //region block: init
