(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).er = function () {
    return this.dr_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.dr_1[index];
  };
  ...
  protoOf(AtomicRef).fr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).gr = function () {
  ...
  protoOf(AtomicBoolean).hr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).gr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).ir = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).gr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).jr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).gr = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).er);
  //endregion
