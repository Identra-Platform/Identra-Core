(function (factory) {
  ...
  var get_indices = kotlin_kotlin.$_$.le;
  ...
  var getOrNull = kotlin_kotlin.$_$.he;
  var isLowSurrogate = kotlin_kotlin.$_$.oe;
  var Char = kotlin_kotlin.$_$.sg;
  var isHighSurrogate = kotlin_kotlin.$_$.ne;
  ...
  function Character() {
    ...
    this.q9q_1 = 65536;
    this.r9q_1 = -56613888;
    this.s9q_1 = _Char___init__impl__6a9atx(55232);
  }
  protoOf(Character).t9q = function (codePoint) {
    return 65536 <= codePoint ? codePoint <= 1114111 : false;
  };
  protoOf(Character).u9q = function (highSurrogate, lowSurrogate) {
    // Inline function 'kotlin.code' call
    var tmp = Char__toInt_impl_vasixd(highSurrogate) << 10;
    // Inline function 'kotlin.code' call
    return (tmp + Char__toInt_impl_vasixd(lowSurrogate) | 0) + -56613888 | 0;
  };
  protoOf(Character).v9q = function (codePoint) {
    return (codePoint >>> 16 | 0) === 0;
  };
  protoOf(Character).w9q = function (codePoint) {
  ...
  protoOf(Character).x9q = function (codePoint) {
  ...
  function appendEncodedDigit($this, _this__u8e3s4, digit) {
    _this__u8e3s4.y8($this.y9q_1[digit & 15]);
  }
  ...
  function codePointAt($this, _this__u8e3s4, index) {
    ...
    if (isHighSurrogate(firstChar)) {
      ...
      if (tmp === true) {
        return Character_getInstance().u9q(firstChar, nextChar);
      }
    }
    // Inline function 'kotlin.code' call
  ...
  function UrlEncoderUtil() {
    ...
    this.y9q_1 = toCharArray('0123456789ABCDEF');
    var tmp = this;
    // Inline function 'kotlin.code' call
  ...
  protoOf(UrlEncoderUtil).a9r = function (source, allow, spaceToPlus) {
    ...
    while (i < source.length) {
      ...
      if (isUnreserved(this, ch) || contains(allow, ch)) {
        ...
        if (cp < 128) {
          ...
          i = i + 1 | 0;
        } else if (Character_getInstance().v9q(cp)) {
          ...
          i = i + 1 | 0;
        } else if (Character_getInstance().t9q(cp)) {
          var high = Character_getInstance().w9q(cp);
          var low = Character_getInstance().x9q(cp);
  ...
  protoOf(UrlEncoderUtil).b9r = function (source, allow, spaceToPlus, $super) {
    allow = allow === VOID ? '' : allow;
    spaceToPlus = spaceToPlus === VOID ? false : spaceToPlus;
    return $super === VOID ? this.a9r(source, allow, spaceToPlus) : $super.a9r.call(this, source, allow, spaceToPlus);
  };
