(function (factory) {
  ...
  protoOf(Final).u6f = function () {
    if (this.v6f_1)
      return this;
    return new Final(this.s6f_1 << 3, this.t6f_1 << 3 | (this.s6f_1 >>> 29 | 0), true);
  };
  function Final_0() {
  }
  protoOf(Bit32).w6f = function () {
    this.p6f_1 = this.p6f_1 + this.o6f_1 | 0;
    if (this.p6f_1 === 0) {
      this.q6f_1 = this.q6f_1 + 1 | 0;
    }
  };
  protoOf(Bit32).x6f = function (additional) {
    var lo = this.p6f_1;
    var hi = this.q6f_1;
    var lt0 = lo < 0;
    lo = lo + additional | 0;
  ...
  protoOf(Final_1).hashCode = function () {
    ...
    if (this instanceof Final) {
      result = imul(result, 31) + this.s6f_1 | 0;
      result = imul(result, 31) + this.t6f_1 | 0;
    } else {
  ...
  protoOf(Final_1).toString = function () {
    var tmp;
    if (this instanceof Final) {
      tmp = 'Counter.Bit32.Final[lo=' + this.s6f_1 + ', hi=' + this.t6f_1 + ']';
    } else {
      if (this instanceof Final_0) {
        tmp = 'Counter.Bit64.Final[lo=' + this.z6f_1.toString() + ', hi=' + this.a6g_1.toString() + ']';
      } else {
  ...
  protoOf(Counter).hashCode = function () {
    return 527 + hashCode(this.b6g_1) | 0;
  };
  protoOf(Counter).toString = function () {
    var tmp;
    if (this instanceof Bit32) {
      tmp = 'Bit32[lo=' + this.p6f_1 + ', hi=' + this.q6f_1 + ', incrementBy=' + this.o6f_1 + ']';
    } else {
      if (this instanceof Bit64) {
        tmp = 'Bit64[lo=' + this.e6g_1.toString() + ', hi=' + this.f6g_1.toString() + ', incrementBy=' + this.d6g_1.toString() + ']';
      } else {
        noWhenBranchMatchedException();
      }
    }
