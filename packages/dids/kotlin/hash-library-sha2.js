(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.n6g_1 = h;
    $this.o6g_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.p6g_1 = h.slice();
    $this.q6g_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).l6f = function (input, offset) {
    ...
    var k = Companion_getInstance().s6g_1;
    var state = this.p6g_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).f6f = function (buf, bufPos) {
    var digest = new Int8Array(this.z6e());
    this.j6f(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).j6f = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.q6g_1.x6f(bufPos).u6f();
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().g6g(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().g6g(bitsLo, buf, 60);
    this.l6f(buf, 0);
    Big_getInstance();
    var tmp9 = this.p6g_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.z6e() / 4 | 0;
    Big_getInstance().h6g(tmp9, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).g6f = function () {
    fill_0(this.o6g_1, 0);
    var tmp0 = this.n6g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.p6g_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().t6g_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.t6g_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
