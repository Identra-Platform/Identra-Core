(function (factory) {
  ...
  function KotlinxSerializer$Companion$DefaultJson$lambda($this$Json) {
    $this$Json.l4q_1 = false;
    $this$Json.k4q_1 = false;
    $this$Json.w4q_1 = true;
    $this$Json.y4q_1 = false;
    return Unit_instance;
  }
  function Companion() {
    Companion_instance = this;
    var tmp = this;
    tmp.j53_1 = Json(VOID, KotlinxSerializer$Companion$DefaultJson$lambda);
  }
  ...
  function KotlinxSerializer(json) {
    ...
    json = json === VOID ? Companion_getInstance().j53_1 : json;
    this.k53_1 = json;
  }
  var initializer;
