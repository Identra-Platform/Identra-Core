(function (factory) {
  ...
  function extensions(format) {
    ...
    while (_iterator__ex2g4s.q()) {
      ...
      var tmp0_safe_receiver = element.l53(format);
  ...
  function serialization(_this__u8e3s4, contentType, format) {
    _this__u8e3s4.k3d(contentType, new KotlinxSerializationConverter(format));
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 3;
            var tmp_0 = this;
            tmp_0.a54_1 = this.u53_1;
            var tmp_1 = this;
            tmp_1.b54_1 = this.z53_1;
            this.c54_1 = this.a54_1;
            this.d54_1 = this.b54_1;
            var tmp_2 = this;
            tmp_2.e54_1 = this.d54_1;
            this.f54_1 = this.e54_1;
            this.m9_1 = 1;
            suspendResult = this.f54_1.h54(this.v53_1, this.w53_1, this.x53_1, this.y53_1, this);
          ...
          case 1:
            ...
            this.m9_1 = 2;
            suspendResult = this.c54_1.c1b(this.g54_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(KotlinxSerializationConverter$serialize$o$collect$slambda).ja = function (value, completion) {
    var i = new KotlinxSerializationConverter$serialize$o$collect$slambda(this.u53_1, this.v53_1, this.w53_1, this.x53_1, this.y53_1, completion);
    i.z53_1 = value;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 2;
            var tmp_0 = this;
            tmp_0.s54_1 = this.r54_1;
            this.t54_1 = this.s54_1;
            this.m9_1 = 1;
            var tmp_1 = KotlinxSerializationConverter$serialize$o$collect$slambda_0(this.t54_1, this.q54_1.v54_1, this.q54_1.w54_1, this.q54_1.x54_1, this.q54_1.y54_1, null);
            suspendResult = this.q54_1.u54_1.e1b(new sam$kotlinx_coroutines_flow_FlowCollector$0(tmp_1), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 3;
            var tmp_0 = this;
            tmp_0.m55_1 = this.h55_1;
            var tmp_1 = this;
            tmp_1.n55_1 = this.l55_1;
            this.o55_1 = this.m55_1;
            this.p55_1 = this.n55_1;
            var tmp_2 = this;
            tmp_2.q55_1 = this.p55_1;
            this.r55_1 = this.q55_1;
            this.m9_1 = 1;
            suspendResult = this.r55_1.h3e(this.i55_1, this.j55_1, this.k55_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            ...
            this.m9_1 = 2;
            suspendResult = this.o55_1.c1b(this.s55_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(KotlinxSerializationConverter$deserialize$o$collect$slambda).ja = function (value, completion) {
    var i = new KotlinxSerializationConverter$deserialize$o$collect$slambda(this.h55_1, this.i55_1, this.j55_1, this.k55_1, completion);
    i.l55_1 = value;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 2;
            var tmp_0 = this;
            tmp_0.d56_1 = this.c56_1;
            this.e56_1 = this.d56_1;
            this.m9_1 = 1;
            var tmp_1 = KotlinxSerializationConverter$deserialize$o$collect$slambda_0(this.e56_1, this.b56_1.g56_1, this.b56_1.h56_1, this.b56_1.i56_1, null);
            suspendResult = this.b56_1.f56_1.e1b(new sam$kotlinx_coroutines_flow_FlowCollector$0_0(tmp_1), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  function serializeContent($this, serializer, format, value, contentType, charset) {
    ...
    if (isInterface(format, StringFormat)) {
      var content = format.j1z(isInterface(serializer, KSerializer) ? serializer : THROW_CCE(), value);
      tmp = new TextContent(content, withCharsetIfNeeded(contentType, charset));
    } else {
      if (isInterface(format, BinaryFormat)) {
        var content_0 = format.l1z(isInterface(serializer, KSerializer) ? serializer : THROW_CCE(), value);
  ...
  function KotlinxSerializationConverter$serialize$$inlined$map$1($this, $contentType, $charset, $typeInfo, $value) {
    this.u54_1 = $this;
    this.v54_1 = $contentType;
    this.w54_1 = $charset;
    this.x54_1 = $typeInfo;
    this.y54_1 = $value;
  }
  protoOf(KotlinxSerializationConverter$serialize$$inlined$map$1).d1b = function (collector, $completion) {
  ...
  protoOf(KotlinxSerializationConverter$serialize$slambda).u56 = function (it, $completion) {
    var tmp = this.v56(it, $completion);
    tmp.o9_1 = Unit_instance;
    tmp.p9_1 = null;
    return tmp.ea();
  };
  protoOf(KotlinxSerializationConverter$serialize$slambda).ua = function (p1, $completion) {
    return this.u56((p1 == null ? true : p1 instanceof OutgoingContent) ? p1 : THROW_CCE(), $completion);
  };
  ...
  protoOf(KotlinxSerializationConverter$serialize$slambda).v56 = function (it, completion) {
  ...
  protoOf(KotlinxSerializationConverter$deserialize$slambda).ea = function () {
    ...
    $sm: do
      try {
        ...
        if (tmp === 0) {
          this.n9_1 = 1;
          return !(this.f57_1 == null) || this.e57_1.o1m();
        } else if (tmp === 1) {
          throw this.p9_1;
        }
      } catch ($p) {
  ...
  protoOf(KotlinxSerializationConverter$deserialize$slambda).ja = function (it, completion) {
    var i = new KotlinxSerializationConverter$deserialize$slambda(this.e57_1, completion);
    i.f57_1 = it;
    return i;
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 2;
            this.m9_1 = 1;
            var this_0 = asFlow(this.o57_1.u57_1);
            var tmp_0 = new KotlinxSerializationConverter$serialize$$inlined$map$1(this_0, this.p57_1, this.q57_1, this.r57_1, this.s57_1);
          ...
          case 1:
            ...
            var tmp_1;
            try {
              tmp_1 = serializerForTypeInfo(this.o57_1.t57_1.i22(), this.r57_1);
            } catch ($p) {
              var tmp_2;
              if ($p instanceof SerializationException) {
                var cause = $p;
                tmp_2 = guessSerializer(this.s57_1, this.o57_1.t57_1.i22());
              } else {
                throw $p;
              }
              tmp_1 = tmp_2;
            ...
            return serializeContent(this.o57_1, serializer, this.o57_1.t57_1, this.s57_1, this.p57_1, this.q57_1);
          case 2:
            throw this.p9_1;
        }
      } catch ($p) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.n9_1 = 4;
            this.m9_1 = 1;
            var this_0 = asFlow(this.d58_1.u57_1);
            var tmp_0 = new KotlinxSerializationConverter$deserialize$$inlined$map$1(this_0, this.e58_1, this.f58_1, this.g58_1);
            suspendResult = firstOrNull(tmp_0, KotlinxSerializationConverter$deserialize$slambda_0(this.g58_1, null), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            ...
            var tmp_1;
            if (!this.d58_1.u57_1.h()) {
              tmp_1 = !(this.h58_1 == null) || this.g58_1.o1m();
            } else {
              tmp_1 = false;
            }
            ...
            if (tmp_1)
              return this.h58_1;
            this.i58_1 = serializerForTypeInfo(this.d58_1.t57_1.i22(), this.f58_1);
            this.m9_1 = 2;
            suspendResult = readRemaining(this.g58_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            ...
            this.n9_1 = 3;
            var tmp0_subject = this.d58_1.t57_1;
            var tmp_2;
            if (isInterface(tmp0_subject, StringFormat)) {
              tmp_2 = this.d58_1.t57_1.k1z(this.i58_1, readText(contentPacket, this.e58_1));
            } else {
              if (isInterface(tmp0_subject, BinaryFormat)) {
                tmp_2 = this.d58_1.t57_1.m1z(this.i58_1, readByteArray(contentPacket));
              } else {
                discard(contentPacket);
                var message = 'Unsupported format ' + toString(this.d58_1.t57_1);
                throw IllegalStateException_init_$Create$(toString(message));
              }
            }
  ...
  function KotlinxSerializationConverter(format) {
    this.t57_1 = format;
    this.u57_1 = extensions(this.t57_1);
    var tmp;
    var tmp_0 = this.t57_1;
    if (isInterface(tmp_0, BinaryFormat)) {
      tmp = true;
    } else {
      var tmp_1 = this.t57_1;
      tmp = isInterface(tmp_1, StringFormat);
    }
    // Inline function 'kotlin.require' call
    if (!tmp) {
      var message = 'Only binary and string formats are supported, ' + toString(this.t57_1) + ' is not supported.';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  protoOf(KotlinxSerializationConverter).j58 = function (contentType, charset, typeInfo, value, $completion) {
  ...
  protoOf(KotlinxSerializationConverter).h54 = function (contentType, charset, typeInfo, value, $completion) {
    return this.j58(contentType, charset, typeInfo, value, $completion);
  };
  ...
  function serializerForTypeInfo(_this__u8e3s4, typeInfo) {
    ...
    var tmp0_safe_receiver = typeInfo.r2s_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
    ...
    if (tmp1_elvis_lhs == null) {
      var tmp2_safe_receiver = module_0.p1z(typeInfo.q2s_1);
      tmp_1 = tmp2_safe_receiver == null ? null : maybeNullable(tmp2_safe_receiver, typeInfo);
    } else {
      tmp_1 = tmp1_elvis_lhs;
    }
    var tmp3_elvis_lhs = tmp_1;
    return tmp3_elvis_lhs == null ? maybeNullable(serializer(typeInfo.q2s_1), typeInfo) : tmp3_elvis_lhs;
  }
        ...
        if (!(value == null) ? isArray(value) : false) {
          ...
          if (!(value == null) ? isInterface(value, KtSet) : false) {
            ...
            if (!(value == null) ? isInterface(value, KtMap) : false) {
              ...
              var tmp3_elvis_lhs = module_0.p1z(getKClassFromExpression(value));
