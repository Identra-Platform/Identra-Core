(function (factory) {
  ...
  function createState(stateRunner, producer) {
    ...
    return runner.a6a(createState$lambda(producer, runner));
  }
  function IsolateState$access$lambda($block, this$0) {
    return function () {
      return $block(this$0.f6a_1.c6a_1);
    };
  }
  function IsolateState(stateHolder) {
    this.f6a_1 = stateHolder;
  }
  protoOf(IsolateState).g6a = function (r) {
    var tmp;
    if (this.f6a_1.e6a_1) {
      tmp = new StateHolder(r, this.f6a_1.b6a_1);
    } else {
      throw IllegalStateException_init_$Create$('Must fork state from the state thread');
    }
    return tmp;
  };
  protoOf(IsolateState).h6a = function (block) {
    var tmp;
    if (this.f6a_1.e6a_1) {
      tmp = block(this.f6a_1.c6a_1);
    } else {
      tmp = this.f6a_1.b6a_1.a6a(IsolateState$access$lambda(block, this));
    }
    return tmp;
  };
  ...
  protoOf(BackgroundStateRunner).a6a = function (block) {
    return block();
  };
  function StateHolder(t, stateRunner) {
    this.b6a_1 = stateRunner;
    this.c6a_1 = t;
    this.d6a_1 = false;
    this.e6a_1 = true;
  }
