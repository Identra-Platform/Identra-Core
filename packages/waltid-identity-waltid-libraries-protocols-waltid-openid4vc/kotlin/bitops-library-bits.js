(function (factory) {
  ...
  protoOf(Final).z6i = function () {
    if (this.a6j_1)
      return this;
    return new Final(this.x6i_1 << 3, this.y6i_1 << 3 | (this.x6i_1 >>> 29 | 0), true);
  };
  function Final_0() {
  }
  protoOf(Bit32).b6j = function () {
    this.u6i_1 = this.u6i_1 + this.t6i_1 | 0;
    if (this.u6i_1 === 0) {
      this.v6i_1 = this.v6i_1 + 1 | 0;
    }
  };
  protoOf(Bit32).c6j = function (additional) {
    var lo = this.u6i_1;
    var hi = this.v6i_1;
    var lt0 = lo < 0;
    lo = lo + additional | 0;
  ...
  protoOf(Final_1).hashCode = function () {
    ...
    result = imul(result, 31) + getBooleanHashCode(this.a6j_1) | 0;
    return result;
  };
  protoOf(Final_1).toString = function () {
    var tmp;
    if (this instanceof Final) {
      tmp = 'Counter.Bit32.Final[lo=' + this.x6i_1 + ', hi=' + this.y6i_1 + ']';
    } else {
      if (this instanceof Final_0) {
        tmp = 'Counter.Bit64.Final[lo=' + this.e6j_1.toString() + ', hi=' + this.f6j_1.toString() + ']';
      } else {
  ...
  protoOf(Counter).hashCode = function () {
    return 527 + hashCode(this.g6j_1) | 0;
  };
  protoOf(Counter).toString = function () {
    var tmp;
    if (this instanceof Bit32) {
      tmp = 'Bit32[lo=' + this.u6i_1 + ', hi=' + this.v6i_1 + ', incrementBy=' + this.t6i_1 + ']';
    } else {
      if (this instanceof Bit64) {
        tmp = 'Bit64[lo=' + this.j6j_1.toString() + ', hi=' + this.k6j_1.toString() + ', incrementBy=' + this.i6j_1.toString() + ']';
      } else {
        noWhenBranchMatchedException();
      }
    }
