(function (factory) {
  ...
  protoOf(Hash).ac4 = function () {
    return Base64_getInstance().fc4(this.zc3_1, true);
  };
  protoOf(Hash).gc4 = function () {
    return Hex_instance.hc4(this.zc3_1);
  };
  protoOf(Hash).equals = function (other) {
    var tmp;
    if (other instanceof Hash) {
      tmp = contentEquals(this.zc3_1, other.zc3_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(Hash).hashCode = function () {
    return contentHashCode(this.zc3_1);
  };
  ...
  protoOf(HasherFactory).m6i = function (data) {
    // Inline function 'kotlin.also' call
    var this_0 = this.jc4_1();
    this_0.qc4(data, 0, data.length);
    return this_0.j6i();
  };
  protoOf(HasherFactory).toString = function () {
    return 'HasherFactory(' + this.ic4_1 + ')';
  };
  function Hasher(chunkSize, digestSize, name) {
    this.kc4_1 = chunkSize;
    this.lc4_1 = digestSize;
    this.mc4_1 = name;
    this.nc4_1 = new Int8Array(this.kc4_1);
    this.oc4_1 = 0;
    this.pc4_1 = new Long(0, 0);
  }
  protoOf(Hasher).qc4 = function (data, offset, count) {
    var curr = offset;
    var left = count;
    while (left > 0) {
      var remainingInChunk = this.kc4_1 - this.oc4_1 | 0;
      // Inline function 'kotlin.math.min' call
      var b = left;
      var toRead = Math.min(remainingInChunk, b);
      arraycopy_0(data, curr, this.nc4_1, this.oc4_1, toRead);
      left = left - toRead | 0;
      curr = curr + toRead | 0;
      this.oc4_1 = this.oc4_1 + toRead | 0;
      if (this.oc4_1 >= this.kc4_1) {
        this.oc4_1 = this.oc4_1 - this.kc4_1 | 0;
        this.rc4(this.nc4_1);
      }
    }
    var tmp = this;
    // Inline function 'kotlin.Long.plus' call
    tmp.pc4_1 = this.pc4_1.c3(toLong(count));
    return this;
  };
  protoOf(Hasher).sc4 = function (out) {
    var pad = this.tc4(this.pc4_1);
    var padPos = 0;
    while (padPos < pad.length) {
      var padSize = this.kc4_1 - this.oc4_1 | 0;
      arraycopy_0(pad, padPos, this.nc4_1, this.oc4_1, padSize);
      this.rc4(this.nc4_1);
      this.oc4_1 = 0;
  ...
  protoOf(Hasher).j6i = function () {
    // Inline function 'kotlin.also' call
    var this_0 = new Int8Array(this.lc4_1);
    this.sc4(this_0);
    return new Hash(this_0);
  };
  protoOf(Hasher).toString = function () {
    return 'Hasher(' + this.mc4_1 + ')';
  };
  function hash(_this__u8e3s4, algo) {
    return algo.m6i(_this__u8e3s4);
  }
  ...
  protoOf(SHA).tc4 = function (totalWritten) {
    // Inline function 'kotlin.Long.rem' call
    var tail = totalWritten.g3(toLong(64));
    var padding = numberToLong(64).d3(tail).h1(new Long(9, 0)) >= 0 ? numberToLong(64).d3(tail) : numberToLong(128).d3(tail);
    // Inline function 'kotlin.also' call
    var this_0 = new Int8Array(padding.m1());
    this_0[0] = -128;
    var pad = this_0;
    // Inline function 'kotlin.Long.times' call
    var bits = totalWritten.e3(toLong(8));
    var inductionVariable = 0;
    if (inductionVariable < 8)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        pad[(pad.length - 1 | 0) - i | 0] = bits.o3(imul(8, i)).p3(new Long(255, 0)).s3();
      }
  ...
  function Companion_0() {
    ...
    tmp.ec5_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
    var tmp_0 = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp_0.fc5_1 = new Int32Array([1116352408, 1899447441, -1245643825, -373957723, 961987163, 1508970993, -1841331548, -1424204075, -670586216, 310598401, 607225278, 1426881987, 1925078388, -2132889090, -1680079193, -1046744716, -459576895, -272742522, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, -1740746414, -1473132947, -1341970488, -1084653625, -958395405, -710438585, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, -2117940946, -1838011259, -1564481375, -1474664885, -1035236496, -949202525, -778901479, -694614492, -200395387, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, -2067236844, -1933114872, -1866530822, -1538233109, -1090935817, -965641998]);
  }
  ...
  function SHA256() {
    ...
    SHA.call(this, 64, 32);
    this.mc5_1 = new Int32Array(8);
    this.nc5_1 = new Int32Array(8);
    this.oc5_1 = new Int32Array(64);
    this.vc4();
  }
  protoOf(SHA256).vc4 = function () {
    arraycopy(Companion_getInstance_0().ec5_1, 0, this.mc5_1, 0, 8);
  };
  protoOf(SHA256).rc4 = function (chunk) {
    arraycopy(this.mc5_1, 0, this.nc5_1, 0, 8);
    var inductionVariable = 0;
    if (inductionVariable < 16)
      do {
        var j = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        this.oc5_1[j] = readS32_be(chunk, imul(j, 4));
      }
    ...
    if (inductionVariable_0 < 64)
      do {
        ...
        var s0 = rotateRight(this.oc5_1[j_0 - 15 | 0], 7) ^ rotateRight(this.oc5_1[j_0 - 15 | 0], 18) ^ (this.oc5_1[j_0 - 15 | 0] >>> 3 | 0);
        var s1 = rotateRight(this.oc5_1[j_0 - 2 | 0], 17) ^ rotateRight(this.oc5_1[j_0 - 2 | 0], 19) ^ (this.oc5_1[j_0 - 2 | 0] >>> 10 | 0);
        this.oc5_1[j_0] = ((this.oc5_1[j_0 - 16 | 0] + s0 | 0) + this.oc5_1[j_0 - 7 | 0] | 0) + s1 | 0;
      }
    ...
    if (inductionVariable_1 < 64)
      do {
        ...
        var s1_0 = rotateRight(this.nc5_1[4], 6) ^ rotateRight(this.nc5_1[4], 11) ^ rotateRight(this.nc5_1[4], 25);
        var ch = this.nc5_1[4] & this.nc5_1[5] ^ ~this.nc5_1[4] & this.nc5_1[6];
        var t1 = (((this.nc5_1[7] + s1_0 | 0) + ch | 0) + Companion_getInstance_0().fc5_1[j_1] | 0) + this.oc5_1[j_1] | 0;
        var s0_0 = rotateRight(this.nc5_1[0], 2) ^ rotateRight(this.nc5_1[0], 13) ^ rotateRight(this.nc5_1[0], 22);
        var maj = this.nc5_1[0] & this.nc5_1[1] ^ this.nc5_1[0] & this.nc5_1[2] ^ this.nc5_1[1] & this.nc5_1[2];
        var t2 = s0_0 + maj | 0;
        this.nc5_1[7] = this.nc5_1[6];
        this.nc5_1[6] = this.nc5_1[5];
        this.nc5_1[5] = this.nc5_1[4];
        this.nc5_1[4] = this.nc5_1[3] + t1 | 0;
        this.nc5_1[3] = this.nc5_1[2];
        this.nc5_1[2] = this.nc5_1[1];
        this.nc5_1[1] = this.nc5_1[0];
        this.nc5_1[0] = t1 + t2 | 0;
      }
    ...
    if (inductionVariable_2 < 8)
      do {
        ...
        var tmp4_array = this.mc5_1;
        tmp4_array[j_2] = tmp4_array[j_2] + this.nc5_1[j_2] | 0;
      }
       while (inductionVariable_2 < 8);
  };
  protoOf(SHA256).uc4 = function (out) {
    var inductionVariable = 0;
    ...
    if (inductionVariable <= last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        out[n] = toByte(this.mc5_1[n / 4 | 0] >>> (24 - imul(8, n % 4 | 0) | 0) | 0);
      }
  ...
  protoOf(ASCII).pc5 = function (str) {
    // Inline function 'kotlin.also' call
  ...
  function Base64() {
    ...
    this.bc4_1 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
    this.cc4_1 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=';
    this.dc4_1 = toDecodeArray(this.bc4_1);
    this.ec4_1 = toDecodeArray(this.cc4_1);
  }
  protoOf(Base64).qc5 = function (src, url, doPadding) {
    var tmp;
    if (url) {
      tmp = this.cc4_1;
    } else {
    ...
    while (ipos < (src.length - 2 | 0)) {
      ...
      ipos = ipos + 3 | 0;
      out.p(charSequenceGet(encodeTable, (num >>> 18 | 0) & 63));
      out.p(charSequenceGet(encodeTable, (num >>> 12 | 0) & 63));
      out.p(charSequenceGet(encodeTable, (num >>> 6 | 0) & 63));
      out.p(charSequenceGet(encodeTable, (num >>> 0 | 0) & 63));
    }
    if (extraBytes === 1) {
      var tmp0 = ipos;
      ipos = tmp0 + 1 | 0;
      var num_0 = readU8(this, src, tmp0);
      out.p(charSequenceGet(encodeTable, num_0 >>> 2 | 0));
      out.p(charSequenceGet(encodeTable, num_0 << 4 & 63));
      if (!url || (url && doPadding)) {
        out.p(_Char___init__impl__6a9atx(61));
        out.p(_Char___init__impl__6a9atx(61));
      }
      ...
      out.p(charSequenceGet(encodeTable, tmp_1 >>> 10 | 0));
      out.p(charSequenceGet(encodeTable, (tmp_1 >>> 4 | 0) & 63));
      out.p(charSequenceGet(encodeTable, tmp_1 << 2 & 63));
      if (!url || (url && doPadding)) {
        out.p(_Char___init__impl__6a9atx(61));
      }
    }
  ...
  protoOf(Base64).fc4 = function (src, url, doPadding, $super) {
    url = url === VOID ? false : url;
    doPadding = doPadding === VOID ? false : doPadding;
    return $super === VOID ? this.qc5(src, url, doPadding) : $super.qc5.call(this, src, url, doPadding);
  };
  var Base64_instance;
  ...
  protoOf(Hex).hc4 = function (src) {
    ...
    if (inductionVariable <= last)
      do {
        ...
        var v = src[n] & 255;
        var it = (v >>> 4 | 0) & 15;
        var tmp$ret$0 = Hex_instance.rc5(it);
        this_0.p(tmp$ret$0);
        var it_0 = (v >>> 0 | 0) & 15;
        var tmp$ret$1 = Hex_instance.rc5(it_0);
        this_0.p(tmp$ret$1);
      }
       while (inductionVariable <= last);
