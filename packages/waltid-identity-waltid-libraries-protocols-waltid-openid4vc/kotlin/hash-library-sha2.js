(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.s6j_1 = h;
    $this.t6j_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.u6j_1 = h.slice();
    $this.v6j_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).q6i = function (input, offset) {
    ...
    var k = Companion_getInstance().x6j_1;
    var state = this.u6j_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).k6i = function (buf, bufPos) {
    var digest = new Int8Array(this.e6i());
    this.o6i(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).o6i = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.v6j_1.c6j(bufPos).z6i();
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().l6j(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().l6j(bitsLo, buf, 60);
    this.q6i(buf, 0);
    Big_getInstance();
    var tmp9 = this.u6j_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.e6i() / 4 | 0;
    Big_getInstance().m6j(tmp9, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).l6i = function () {
    fill_0(this.t6j_1, 0);
    var tmp0 = this.s6j_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.u6j_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().y6j_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.y6j_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
