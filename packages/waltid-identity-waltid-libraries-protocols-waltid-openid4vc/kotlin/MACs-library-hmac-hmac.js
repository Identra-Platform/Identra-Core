(function (factory) {
  ...
  function Engine_init_$Init$_0(key, digest, $this) {
    ...
    Engine_0.call($this);
    $this.j6k_1 = digest;
    $this.h6k_1 = new Int8Array(digest.d6i());
    $this.i6k_1 = new Int8Array(digest.d6i());
    var tmp1 = $this.j6k_1;
    var tmp3 = $this.h6k_1;
    // Inline function 'org.kotlincrypto.macs.hmac.Engine.doInitialization' call
    var oKey = $this.i6k_1;
    var blockSize = tmp1.d6i();
    if (false) {
      tmp1.p6i();
    }
    var tmp;
    if (key.length > blockSize) {
      var keyHash = tmp1.m6i(key);
  ...
  protoOf(Engine_0).i6i = function (input, offset, len) {
    this.j6k_1.i6i(input, offset, len);
  };
  protoOf(Engine_0).d6k = function () {
    var final = new Int8Array(this.j6k_1.e6i());
    this.m6k(final, 0);
    return final;
  };
  protoOf(Engine_0).m6k = function (dest, destOffset) {
    var inner = this.j6k_1.j6i();
    this.j6k_1.g6i(this.i6k_1);
    this.j6k_1.g6i(inner);
    this.j6k_1.n6i(dest, destOffset);
    this.j6k_1.g6i(this.h6k_1);
  };
  protoOf(Engine_0).p6i = function () {
    this.j6k_1.p6i();
    this.j6k_1.g6i(this.h6k_1);
  };
  function Engine_0() {
