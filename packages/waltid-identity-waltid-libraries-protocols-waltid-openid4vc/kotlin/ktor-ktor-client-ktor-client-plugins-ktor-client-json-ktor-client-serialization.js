(function (factory) {
  ...
  function KotlinxSerializer$Companion$DefaultJson$lambda($this$Json) {
    $this$Json.b4t_1 = false;
    $this$Json.a4t_1 = false;
    $this$Json.m4t_1 = true;
    $this$Json.o4t_1 = false;
    return Unit_instance;
  }
  function Companion() {
    Companion_instance = this;
    var tmp = this;
    tmp.f56_1 = Json(VOID, KotlinxSerializer$Companion$DefaultJson$lambda);
  }
  ...
  function KotlinxSerializer(json) {
    ...
    json = json === VOID ? Companion_getInstance().f56_1 : json;
    this.g56_1 = json;
  }
  var initializer;
