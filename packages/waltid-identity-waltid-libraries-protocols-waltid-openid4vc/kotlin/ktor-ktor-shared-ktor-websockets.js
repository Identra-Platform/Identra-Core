(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    globalThis['ktor-ktor-shared-ktor-websockets'] = factory(typeof globalThis['ktor-ktor-shared-ktor-websockets'] === 'undefined' ? {} : globalThis['ktor-ktor-shared-ktor-websockets'], globalThis['kotlin-kotlin-stdlib'], globalThis['ktor-ktor-io'], globalThis['kotlinx-io-kotlinx-io-core']);
  }
  ...
  function Companion() {
    ...
    while (_iterator__ex2g4s.r()) {
      ...
      var tmp$ret$0 = element.s3e_1;
      destination.q2(tmp$ret$0, element);
    }
    tmp.t3e_1 = destination;
    this.u3e_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).v3e = function (code) {
    return this.t3e_1.n2(code);
  };
  ...
  protoOf(CloseReason).y3e = function () {
    return Companion_getInstance().v3e(this.w3e_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.y3e();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.w3e_1 : tmp0_elvis_lhs) + ', message=' + this.x3e_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.w3e_1;
    result = imul(result, 31) + getStringHashCode(this.x3e_1) | 0;
    return result;
  };
  protoOf(CloseReason).equals = function (other) {
    ...
    if (!(this.w3e_1 === tmp0_other_with_cast.w3e_1))
      return false;
    if (!(this.x3e_1 === tmp0_other_with_cast.x3e_1))
      return false;
    return true;
  };
  ...
  function Companion_0() {
    ...
    tmp.d3f_1 = ensureNotNull(tmp$ret$0).c3f_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.d3f_1 + 1 | 0;
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    builder.m1l(reason.w3e_1);
    writeText(builder, reason.x3e_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().f3f_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.g3f_1 = fin;
    this.h3f_1 = frameType;
    this.i3f_1 = data;
    this.j3f_1 = disposableHandle;
    this.k3f_1 = rsv1;
    this.l3f_1 = rsv2;
    this.m3f_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.h3f_1.toString() + ' (fin=' + this.g3f_1 + ', buffer len = ' + this.i3f_1.length + ')';
  };
  //region block: init
