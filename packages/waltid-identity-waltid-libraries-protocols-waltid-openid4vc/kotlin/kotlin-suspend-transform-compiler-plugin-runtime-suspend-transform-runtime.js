(function (factory) {
  ...
  protoOf($runInAsync$$slambda).b1j = function ($this$promise, $completion) {
    var tmp = this.c1j($this$promise, $completion);
    tmp.p9_1 = Unit_instance;
    tmp.q9_1 = null;
    return tmp.fa();
  };
  protoOf($runInAsync$$slambda).va = function (p1, $completion) {
    return this.b1j((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf($runInAsync$$slambda).fa = function () {
  ...
  protoOf($runInAsync$$slambda).c1j = function ($this$promise, completion) {
    var i = new $runInAsync$$slambda(this.z1i_1, completion);
  ...
  function $runInAsync$$slambda_0($block, resultContinuation) {
    ...
    var l = function ($this$promise, $completion) {
      return i.b1j($this$promise, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  function _init_properties_RunInSuspendJs_kt__7srfl7() {
    if (!properties_initialized_RunInSuspendJs_kt_c7ufpz) {
      ...
      CoroutineContext4Js = Dispatchers_getInstance().f14_1.yj(SupervisorJob());
