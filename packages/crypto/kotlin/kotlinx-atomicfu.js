(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).yq = function () {
    return this.xq_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.xq_1[index];
  };
  ...
  protoOf(AtomicRef).zq = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).ar = function () {
  ...
  protoOf(AtomicBoolean).br = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).ar = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).cr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).ar = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).dr = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).ar = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).yq);
  //endregion
