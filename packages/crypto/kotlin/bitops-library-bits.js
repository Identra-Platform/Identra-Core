(function (factory) {
  ...
  protoOf(Final).bc = function () {
    return this.y6d_1;
  };
  protoOf(Final).cc = function () {
    return this.z6d_1;
  };
  protoOf(Final).a6e = function () {
    if (this.b6e_1)
      return this;
    return new Final(this.y6d_1 << 3, this.z6d_1 << 3 | (this.y6d_1 >>> 29 | 0), true);
  };
  function Final_0() {
  }
  protoOf(Bit32).c6e = function () {
    this.v6d_1 = this.v6d_1 + this.u6d_1 | 0;
    if (this.v6d_1 === 0) {
      this.w6d_1 = this.w6d_1 + 1 | 0;
    }
  };
  protoOf(Bit32).d6e = function (additional) {
    var lo = this.v6d_1;
    var hi = this.w6d_1;
    var lt0 = lo < 0;
    lo = lo + additional | 0;
  ...
  protoOf(Final_1).hashCode = function () {
    ...
    if (this instanceof Final) {
      ...
      if (this instanceof Final_0) {
        result = imul(result, 31) + this.f6e_1.hashCode() | 0;
        result = imul(result, 31) + this.g6e_1.hashCode() | 0;
      }
    }
  ...
  protoOf(Final_1).toString = function () {
    var tmp;
    if (this instanceof Final) {
      tmp = 'Counter.Bit32.Final[lo=' + this.y6d_1 + ', hi=' + this.z6d_1 + ']';
    } else {
      if (this instanceof Final_0) {
        tmp = 'Counter.Bit64.Final[lo=' + this.f6e_1.toString() + ', hi=' + this.g6e_1.toString() + ']';
      } else {
  ...
  protoOf(Counter).hashCode = function () {
    return 527 + hashCode(this.h6e_1) | 0;
  };
  protoOf(Counter).toString = function () {
    var tmp;
    if (this instanceof Bit32) {
      tmp = 'Bit32[lo=' + this.v6d_1 + ', hi=' + this.w6d_1 + ', incrementBy=' + this.u6d_1 + ']';
    } else {
      if (this instanceof Bit64) {
        tmp = 'Bit64[lo=' + this.k6e_1.toString() + ', hi=' + this.l6e_1.toString() + ', incrementBy=' + this.j6e_1.toString() + ']';
      } else {
        noWhenBranchMatchedException();
      }
    }
