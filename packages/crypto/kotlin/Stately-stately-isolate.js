(function (factory) {
  ...
  function createState(stateRunner, producer) {
    ...
    return runner.t67(createState$lambda(producer, runner));
  }
  function IsolateState$access$lambda($block, this$0) {
    return function () {
      return $block(this$0.y67_1.v67_1);
    };
  }
  function IsolateState(stateHolder) {
    this.y67_1 = stateHolder;
  }
  protoOf(IsolateState).z67 = function (r) {
    var tmp;
    if (this.y67_1.x67_1) {
      tmp = new StateHolder(r, this.y67_1.u67_1);
    } else {
      throw IllegalStateException_init_$Create$('Must fork state from the state thread');
    }
    return tmp;
  };
  protoOf(IsolateState).a68 = function (block) {
    var tmp;
    if (this.y67_1.x67_1) {
      tmp = block(this.y67_1.v67_1);
    } else {
      tmp = this.y67_1.u67_1.t67(IsolateState$access$lambda(block, this));
    }
    return tmp;
  };
  ...
  protoOf(BackgroundStateRunner).t67 = function (block) {
    return block();
  };
  function StateHolder(t, stateRunner) {
    this.u67_1 = stateRunner;
    this.v67_1 = t;
    this.w67_1 = false;
    this.x67_1 = true;
  }
