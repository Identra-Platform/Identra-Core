(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.t6e_1 = h;
    $this.u6e_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.v6e_1 = h.slice();
    $this.w6e_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).j6d = function (input, offset) {
    ...
    var k = Companion_getInstance().y6e_1;
    var state = this.v6e_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).e6d = function (buf, bufPos) {
    var digest = new Int8Array(this.a6d());
    this.i6d(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).i6d = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.w6e_1.d6e(bufPos).a6e();
    var bitsLo = tmp0_container.bc();
    var bitsHi = tmp0_container.cc();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.j6d(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().m6e(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().m6e(bitsLo, buf, 60);
    this.j6d(buf, 0);
    Big_getInstance();
    var tmp9 = this.v6e_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.a6d() / 4 | 0;
    Big_getInstance().n6e(tmp9, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).f6d = function () {
    fill_0(this.u6e_1, 0);
    var tmp0 = this.t6e_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.v6e_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().z6e_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.z6e_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
