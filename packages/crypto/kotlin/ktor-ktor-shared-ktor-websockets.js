(function (factory) {
  ...
  function Companion() {
    ...
    while (_iterator__ex2g4s.q()) {
      ...
      var tmp$ret$0 = element.p3b_1;
      destination.n2(tmp$ret$0, element);
    }
    tmp.q3b_1 = destination;
    this.r3b_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).s3b = function (code) {
    return this.q3b_1.k2(code);
  };
  ...
  protoOf(CloseReason).v3b = function () {
    return Companion_getInstance().s3b(this.t3b_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.v3b();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.t3b_1 : tmp0_elvis_lhs) + ', message=' + this.u3b_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.t3b_1;
    result = imul(result, 31) + getStringHashCode(this.u3b_1) | 0;
    return result;
  };
  protoOf(CloseReason).equals = function (other) {
    ...
    if (!(this.t3b_1 === tmp0_other_with_cast.t3b_1))
      return false;
    if (!(this.u3b_1 === tmp0_other_with_cast.u3b_1))
      return false;
    return true;
  };
  ...
  function Companion_0() {
    ...
    tmp.a3c_1 = ensureNotNull(tmp$ret$0).z3b_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.a3c_1 + 1 | 0;
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    builder.k1i(reason.t3b_1);
    writeText(builder, reason.u3b_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().c3c_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.d3c_1 = fin;
    this.e3c_1 = frameType;
    this.f3c_1 = data;
    this.g3c_1 = disposableHandle;
    this.h3c_1 = rsv1;
    this.i3c_1 = rsv2;
    this.j3c_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.e3c_1.toString() + ' (fin=' + this.d3c_1 + ', buffer len = ' + this.f3c_1.length + ')';
  };
  //region block: init
