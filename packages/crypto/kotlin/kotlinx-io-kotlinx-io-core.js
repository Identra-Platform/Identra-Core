(function (factory) {
  ...
  var toShort = kotlin_kotlin.$_$.sc;
  ...
  function write$default(source, startIndex, endIndex, $super) {
    ...
    var tmp;
    if ($super === VOID) {
      this.y1h(source, startIndex, endIndex);
      tmp = Unit_instance;
    } else {
      tmp = $super.y1h.call(this, source, startIndex, endIndex);
    }
    return tmp;
  }
  ...
  protoOf(Buffer).q1g = function (byteCount) {
  ...
  protoOf(Buffer).r1g = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount.e1(new Long(0, 0)) >= 0)) {
  ...
  protoOf(Buffer).s1g = function () {
    ...
    var v = segment.b1h();
    this.n1g_1 = this.n1g_1.a3(new Long(1, 0));
    if (segmentSize === 1) {
      this.a1h();
    }
    return v;
  };
  protoOf(Buffer).c1h = function () {
    var tmp0_elvis_lhs = this.l1g_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
    ...
    var segmentSize = segment.s();
    if (segmentSize < 2) {
      this.q1g(new Long(2, 0));
      if (segmentSize === 0) {
        this.a1h();
        return this.c1h();
      }
      // Inline function 'kotlinx.io.and' call
      var tmp_0 = (this.s1g() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.s1g() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.d1h();
    this.n1g_1 = this.n1g_1.a3(new Long(2, 0));
    if (segmentSize === 2) {
      this.a1h();
    }
    return v;
  ...
  protoOf(Buffer).f1h = function (out, startIndex, endIndex) {
    checkBounds(this.s(), startIndex, endIndex);
    if (startIndex.equals(endIndex))
      return Unit_instance;
    var currentOffset = startIndex;
    var remainingByteCount = endIndex.a3(startIndex);
    out.n1g_1 = out.n1g_1.z2(remainingByteCount);
    var s = this.l1g_1;
    while (currentOffset.e1(toLong(ensureNotNull(s).v1g_1 - s.u1g_1 | 0)) >= 0) {
      currentOffset = currentOffset.a3(toLong(s.v1g_1 - s.u1g_1 | 0));
      s = s.y1g_1;
    }
    while (remainingByteCount.e1(new Long(0, 0)) > 0) {
      var copy = ensureNotNull(s).g1h();
      copy.u1g_1 = copy.u1g_1 + currentOffset.j1() | 0;
      var tmp = copy;
      var tmp0 = copy.u1g_1 + remainingByteCount.j1() | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.v1g_1;
      tmp.v1g_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.l1g_1 == null) {
        out.l1g_1 = copy;
        out.m1g_1 = copy;
      } else if (false) {
        out.m1g_1 = ensureNotNull(out.m1g_1).h1h(copy).i1h();
        if (ensureNotNull(out.m1g_1).z1g_1 == null) {
          out.l1g_1 = out.m1g_1;
        }
      } else {
        out.m1g_1 = ensureNotNull(out.m1g_1).h1h(copy);
      }
      remainingByteCount = remainingByteCount.a3(toLong(copy.v1g_1 - copy.u1g_1 | 0));
  ...
  protoOf(Buffer).j1h = function () {
    ...
    if (result.equals(new Long(0, 0)))
      return new Long(0, 0);
    var tail = ensureNotNull(this.m1g_1);
    if (tail.v1g_1 < 8192 && tail.x1g_1) {
      result = result.a3(toLong(tail.v1g_1 - tail.u1g_1 | 0));
    }
    return result;
  };
  protoOf(Buffer).k1h = function (position) {
    ...
    if (position.equals(new Long(0, 0))) {
      return ensureNotNull(this.l1g_1).l1h(0);
    }
    // Inline function 'kotlinx.io.seek' call
    if (this.l1g_1 == null) {
      var offset = new Long(-1, -1);
      return ensureNotNull(null).l1h(position.a3(offset).j1());
    }
    if (this.s().a3(position).e1(position) < 0) {
      var s = this.m1g_1;
      var offset_0 = this.s();
      $l$loop: while (!(s == null) && offset_0.e1(position) > 0) {
        offset_0 = offset_0.a3(toLong(s.v1g_1 - s.u1g_1 | 0));
      ...
      return ensureNotNull(tmp4).l1h(position.a3(offset_1).j1());
    } else {
      var s_0 = this.l1g_1;
      ...
      $l$loop_0: while (!(s_0 == null)) {
        ...
        var other = s_0.v1g_1 - s_0.u1g_1 | 0;
      ...
      return ensureNotNull(tmp6).l1h(position.a3(offset_3).j1());
    }
  };
  protoOf(Buffer).e2 = function () {
    return this.m1h(this.s());
  };
  protoOf(Buffer).m1h = function (byteCount) {
    ...
    while (remainingByteCount.e1(new Long(0, 0)) > 0) {
      ...
      var b = head.v1g_1 - head.u1g_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = toLong(b);
      var toSkip = (tmp1.e1(b_0) <= 0 ? tmp1 : b_0).j1();
      this.n1g_1 = this.n1g_1.a3(toLong(toSkip));
      remainingByteCount = remainingByteCount.a3(toLong(toSkip));
      head.u1g_1 = head.u1g_1 + toSkip | 0;
      if (head.u1g_1 === head.v1g_1) {
        this.a1h();
      }
    }
  };
  protoOf(Buffer).n1h = function (sink, startIndex, endIndex) {
    ...
    s.o1h(sink, startIndex, startIndex + toCopy | 0);
    this.n1g_1 = this.n1g_1.a3(toLong(toCopy));
    if (isEmpty(s)) {
      this.a1h();
    }
    return toCopy;
  };
  protoOf(Buffer).p1h = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(byteCount.e1(new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.q1h(this, bytesWritten);
    return bytesWritten;
  };
  protoOf(Buffer).r1h = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(byteCount.e1(new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.q1h(this, byteCount);
  };
  protoOf(Buffer).s1h = function (sink) {
  ...
  protoOf(Buffer).u1h = function (minimumCapacity) {
    ...
    if (this.m1g_1 == null) {
      var result = SegmentPool_instance.x1h();
      this.l1g_1 = result;
      this.m1g_1 = result;
      return result;
    }
    var t = ensureNotNull(this.m1g_1);
    if ((t.v1g_1 + minimumCapacity | 0) > 8192 || !t.x1g_1) {
      var newTail = t.h1h(SegmentPool_instance.x1h());
      this.m1g_1 = newTail;
      return newTail;
    }
    return t;
  };
  protoOf(Buffer).y1h = function (source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.z1h();
      var toCopy = Math.min(tmp3, b);
      tail.a1i(source, currentOffset, currentOffset + toCopy | 0);
    ...
    tmp.n1g_1 = tmp5.z2(toLong(other));
  };
  protoOf(Buffer).c1i = function (source, byteCount) {
    ...
    var remainingByteCount = byteCount;
    while (remainingByteCount.e1(new Long(0, 0)) > 0) {
      var read = source.p1h(this, remainingByteCount);
  ...
  protoOf(Buffer).q1h = function (source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    checkOffsetAndCount(source.n1g_1, new Long(0, 0), byteCount);
    var remainingByteCount = byteCount;
    while (remainingByteCount.e1(new Long(0, 0)) > 0) {
      if (remainingByteCount.e1(toLong(ensureNotNull(source.l1g_1).s())) < 0) {
        var tail = this.m1g_1;
        var tmp;
        if (!(tail == null) && tail.x1g_1) {
          var tmp1 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.v1g_1;
          var tmp3 = tmp1.z2(toLong(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.d1i() ? 0 : tail.u1g_1;
          tmp = tmp3.a3(toLong(other_0)).e1(new Long(8192, 0)) <= 0;
        } else {
          tmp = false;
        }
        if (tmp) {
          ensureNotNull(source.l1g_1).f1i(tail, remainingByteCount.j1());
          source.n1g_1 = source.n1g_1.a3(remainingByteCount);
          this.n1g_1 = this.n1g_1.z2(remainingByteCount);
          return Unit_instance;
        } else {
          source.l1g_1 = ensureNotNull(source.l1g_1).e1i(remainingByteCount.j1());
        }
      }
      var segmentToMove = ensureNotNull(source.l1g_1);
      var movedByteCount = toLong(segmentToMove.s());
      source.l1g_1 = segmentToMove.g1i();
      if (source.l1g_1 == null) {
        source.m1g_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.l1g_1 == null) {
        this.l1g_1 = segmentToMove;
        this.m1g_1 = segmentToMove;
      } else if (true) {
        this.m1g_1 = ensureNotNull(this.m1g_1).h1h(segmentToMove).i1h();
        if (ensureNotNull(this.m1g_1).z1g_1 == null) {
          this.l1g_1 = this.m1g_1;
        }
      } else {
        this.m1g_1 = ensureNotNull(this.m1g_1).h1h(segmentToMove);
      }
      source.n1g_1 = source.n1g_1.a3(movedByteCount);
      this.n1g_1 = this.n1g_1.z2(movedByteCount);
      remainingByteCount = remainingByteCount.a3(movedByteCount);
    }
  };
  protoOf(Buffer).h1i = function (source) {
    var totalBytesRead = new Long(0, 0);
    $l$loop: while (true) {
      var readCount = source.p1h(this, new Long(8192, 0));
  ...
  protoOf(Buffer).i1i = function (byte) {
    this.u1h(1).j1i(byte);
    this.n1g_1 = this.n1g_1.z2(new Long(1, 0));
  };
  protoOf(Buffer).k1i = function (short) {
    this.u1h(2).l1i(short);
    this.n1g_1 = this.n1g_1.z2(new Long(2, 0));
  };
  ...
  protoOf(Buffer).toString = function () {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.s()) {
        ...
        var b_0 = tmp4.m1i(segment, _unary__edvuaz);
  ...
  protoOf(Buffer).a1h = function () {
    var oldHead = ensureNotNull(this.l1g_1);
    var nextHead = oldHead.y1g_1;
    this.l1g_1 = nextHead;
    if (nextHead == null) {
      this.m1g_1 = null;
    } else {
    ...
    oldHead.y1g_1 = null;
    SegmentPool_instance.n1i(oldHead);
  };
  protoOf(Buffer).o1i = function () {
    var oldTail = ensureNotNull(this.m1g_1);
    var newTail = oldTail.z1g_1;
    this.m1g_1 = newTail;
    if (newTail == null) {
      this.l1g_1 = null;
    } else {
    ...
    oldTail.z1g_1 = null;
    SegmentPool_instance.n1i(oldTail);
  };
  function readByteString(_this__u8e3s4, byteCount) {
    return UnsafeByteStringOperations_instance.k1g(readByteArray_0(_this__u8e3s4, byteCount));
  }
  ...
  function PeekSource(upstream) {
    this.p1i_1 = upstream;
    this.q1i_1 = this.p1i_1.o1g();
    this.r1i_1 = this.q1i_1.l1g_1;
    var tmp = this;
    var tmp0_safe_receiver = this.q1i_1.l1g_1;
    var tmp0_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.u1g_1;
    tmp.s1i_1 = tmp0_elvis_lhs == null ? -1 : tmp0_elvis_lhs;
    this.t1i_1 = false;
    this.u1i_1 = new Long(0, 0);
  }
  protoOf(PeekSource).p1h = function (sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.r1i_1 == null || (this.r1i_1 === this.q1i_1.l1g_1 && this.s1i_1 === ensureNotNull(this.q1i_1.l1g_1).u1g_1))) {
    ...
    if (byteCount.equals(new Long(0, 0)))
      return new Long(0, 0);
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$7 = this.u1i_1.z2(toLong(1));
    if (!this.p1i_1.r1g(tmp$ret$7))
      return new Long(-1, -1);
    if (this.r1i_1 == null && !(this.q1i_1.l1g_1 == null)) {
      this.r1i_1 = this.q1i_1.l1g_1;
      this.s1i_1 = ensureNotNull(this.q1i_1.l1g_1).u1g_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = this.q1i_1.s().a3(this.u1i_1);
    var toCopy = byteCount.e1(b) <= 0 ? byteCount : b;
    this.q1i_1.f1h(sink, this.u1i_1, this.u1i_1.z2(toCopy));
    this.u1i_1 = this.u1i_1.z2(toCopy);
    return toCopy;
  };
  ...
  function RealSource(source) {
    this.v1i_1 = source;
    this.w1i_1 = false;
    this.x1i_1 = new Buffer();
  }
  protoOf(RealSource).o1g = function () {
    return this.x1i_1;
  };
  protoOf(RealSource).p1h = function (sink, byteCount) {
    ...
    if (this.x1i_1.s().equals(new Long(0, 0))) {
      var read = this.v1i_1.p1h(this.x1i_1, new Long(8192, 0));
      if (read.equals(new Long(-1, -1)))
        return new Long(-1, -1);
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.x1i_1.p1h(sink, toRead);
  };
  protoOf(RealSource).p1g = function () {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.w1i_1) {
      var message = 'Source is closed.';
    ...
    return this.x1i_1.p1g() && this.v1i_1.p1h(this.x1i_1, new Long(8192, 0)).equals(new Long(-1, -1));
  };
  protoOf(RealSource).q1g = function (byteCount) {
    if (!this.r1g(byteCount))
      throw EOFException_init_$Create$_0("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  };
  protoOf(RealSource).r1g = function (byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.w1i_1) {
      var message = 'Source is closed.';
    ...
    while (this.x1i_1.s().e1(byteCount) < 0) {
      if (this.v1i_1.p1h(this.x1i_1, new Long(8192, 0)).equals(new Long(-1, -1)))
        return false;
    }
    return true;
  };
  protoOf(RealSource).s1g = function () {
    this.q1g(new Long(1, 0));
    return this.x1i_1.s1g();
  };
  protoOf(RealSource).n1h = function (sink, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    var size = sink.length;
    checkBounds(toLong(size), toLong(startIndex), toLong(endIndex));
    if (this.x1i_1.s().equals(new Long(0, 0))) {
    ...
    return this.x1i_1.n1h(sink, startIndex, startIndex + toRead | 0);
  };
  protoOf(RealSource).r1h = function (sink, byteCount) {
    try {
      this.q1g(byteCount);
    } catch ($p) {
      if ($p instanceof EOFException) {
        var e = $p;
        sink.q1h(this.x1i_1, this.x1i_1.s());
        throw e;
      } else {
        throw $p;
      }
    }
    this.x1i_1.r1h(sink, byteCount);
  };
  protoOf(RealSource).s1h = function (sink) {
    var totalBytesWritten = new Long(0, 0);
    while (!this.v1i_1.p1h(this.x1i_1, new Long(8192, 0)).equals(new Long(-1, -1))) {
      var emitByteCount = this.x1i_1.j1h();
      if (emitByteCount.e1(new Long(0, 0)) > 0) {
        totalBytesWritten = totalBytesWritten.z2(emitByteCount);
        sink.q1h(this.x1i_1, emitByteCount);
      }
    }
    if (this.x1i_1.s().e1(new Long(0, 0)) > 0) {
      totalBytesWritten = totalBytesWritten.z2(this.x1i_1.s());
      sink.q1h(this.x1i_1, this.x1i_1.s());
    }
    return totalBytesWritten;
  };
  protoOf(RealSource).c1h = function () {
    this.q1g(new Long(2, 0));
    return this.x1i_1.c1h();
  };
  protoOf(RealSource).t1h = function () {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.w1i_1) {
      var message = 'Source is closed.';
  ...
  protoOf(RealSource).toString = function () {
    return 'buffered(' + toString(this.v1i_1) + ')';
  };
  function Segment_init_$Init$($this) {
    Segment.call($this);
    $this.t1g_1 = new Int8Array(8192);
    $this.x1g_1 = true;
    $this.w1g_1 = null;
    return $this;
  }
  ...
  protoOf(Companion).a1j = function () {
  ...
  protoOf(Segment).d1i = function () {
    var tmp1_safe_receiver = this.w1g_1;
    var tmp0_elvis_lhs = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.b1j();
    return tmp0_elvis_lhs == null ? false : tmp0_elvis_lhs;
  };
  protoOf(Segment).g1h = function () {
    var tmp0_elvis_lhs = this.w1g_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = SegmentPool_instance.c1j();
      this.w1g_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    ...
    var t = tmp;
    var tmp_0 = this.u1g_1;
    var tmp_1 = this.v1g_1;
    // Inline function 'kotlin.also' call
    t.d1j();
    return Segment_init_$Create$_0(this.t1g_1, tmp_0, tmp_1, t, false);
  };
  protoOf(Segment).g1i = function () {
    var result = this.y1g_1;
    if (!(this.z1g_1 == null)) {
      ensureNotNull(this.z1g_1).y1g_1 = this.y1g_1;
    }
    if (!(this.y1g_1 == null)) {
      ensureNotNull(this.y1g_1).z1g_1 = this.z1g_1;
    }
    this.y1g_1 = null;
    this.z1g_1 = null;
    return result;
  };
  protoOf(Segment).h1h = function (segment) {
    segment.z1g_1 = this;
    segment.y1g_1 = this.y1g_1;
    if (!(this.y1g_1 == null)) {
      ensureNotNull(this.y1g_1).z1g_1 = segment;
    }
    this.y1g_1 = segment;
    return segment;
  };
  protoOf(Segment).e1i = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.v1g_1 - this.u1g_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.x1h();
      var tmp1 = this.t1g_1;
      var tmp2 = prefix.t1g_1;
      var tmp3 = this.u1g_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.u1g_1 + byteCount | 0;
    ...
    prefix.v1g_1 = prefix.u1g_1 + byteCount | 0;
    this.u1g_1 = this.u1g_1 + byteCount | 0;
    if (!(this.z1g_1 == null)) {
      ensureNotNull(this.z1g_1).h1h(prefix);
    } else {
      prefix.y1g_1 = this;
      this.z1g_1 = prefix;
    }
  ...
  protoOf(Segment).i1h = function () {
    // Inline function 'kotlin.check' call
    if (!!(this.z1g_1 == null)) {
      var message = 'cannot compact';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    if (!ensureNotNull(this.z1g_1).x1g_1)
      return this;
    var byteCount = this.v1g_1 - this.u1g_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.z1g_1).v1g_1 | 0) + (ensureNotNull(this.z1g_1).d1i() ? 0 : ensureNotNull(this.z1g_1).u1g_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.z1g_1;
    this.f1i(ensureNotNull(predecessor), byteCount);
    var successor = this.g1i();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
    SegmentPool_instance.n1i(this);
    return predecessor;
  };
  protoOf(Segment).j1i = function (byte) {
    var _unary__edvuaz = this.v1g_1;
    this.v1g_1 = _unary__edvuaz + 1 | 0;
    this.t1g_1[_unary__edvuaz] = byte;
  };
  protoOf(Segment).l1i = function (short) {
    var data = this.t1g_1;
    var limit = this.v1g_1;
  ...
  protoOf(Segment).b1h = function () {
    var _unary__edvuaz = this.u1g_1;
    this.u1g_1 = _unary__edvuaz + 1 | 0;
    return this.t1g_1[_unary__edvuaz];
  };
  protoOf(Segment).d1h = function () {
    var data = this.t1g_1;
    var pos = this.u1g_1;
  ...
  protoOf(Segment).f1i = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!sink.x1g_1) {
      var message = 'only owner can write';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    if ((sink.v1g_1 + byteCount | 0) > 8192) {
      if (sink.d1i())
        throw IllegalArgumentException_init_$Create$_0();
      if (((sink.v1g_1 + byteCount | 0) - sink.u1g_1 | 0) > 8192)
        throw IllegalArgumentException_init_$Create$_0();
      var tmp1 = sink.t1g_1;
      var tmp2 = sink.t1g_1;
      var tmp3 = sink.u1g_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.v1g_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp3, endIndex);
      sink.v1g_1 = sink.v1g_1 - sink.u1g_1 | 0;
      sink.u1g_1 = 0;
    }
    var tmp6 = this.t1g_1;
    var tmp7 = sink.t1g_1;
    ...
    var tmp9 = this.u1g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.u1g_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp6;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.v1g_1 = sink.v1g_1 + byteCount | 0;
    this.u1g_1 = this.u1g_1 + byteCount | 0;
  };
  protoOf(Segment).o1h = function (dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.t1g_1;
    var tmp3 = this.u1g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.u1g_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.u1g_1 = this.u1g_1 + len | 0;
  };
  protoOf(Segment).a1i = function (src, srcStartOffset, srcEndOffset) {
    var tmp1 = this.t1g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.v1g_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.v1g_1 = this.v1g_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  };
  protoOf(Segment).s = function () {
    return this.v1g_1 - this.u1g_1 | 0;
  };
  protoOf(Segment).z1h = function () {
    return this.t1g_1.length - this.v1g_1 | 0;
  };
  protoOf(Segment).e1j = function (readOnly) {
    return this.t1g_1;
  };
  protoOf(Segment).l1h = function (index) {
    return this.t1g_1[this.u1g_1 + index | 0];
  };
  protoOf(Segment).f1j = function (index, value) {
    this.t1g_1[this.v1g_1 + index | 0] = value;
  };
  protoOf(Segment).g1j = function (index, b0, b1) {
    var d = this.t1g_1;
    var l = this.v1g_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  };
  protoOf(Segment).h1j = function (index, b0, b1, b2) {
    var d = this.t1g_1;
    var l = this.v1g_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(Segment).i1j = function (index, b0, b1, b2, b3) {
    var d = this.t1g_1;
    var l = this.v1g_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(AlwaysSharedCopyTracker).b1j = function () {
    return true;
  };
  protoOf(AlwaysSharedCopyTracker).d1j = function () {
    return Unit_instance;
  };
  ...
  function readByteArrayImpl(_this__u8e3s4, size) {
    ...
    if (size === -1) {
      ...
      while (_this__u8e3s4.o1g().s().e1(new Long(2147483647, 0)) < 0 && _this__u8e3s4.r1g(fetchSize)) {
        // Inline function 'kotlin.Long.times' call
        fetchSize = fetchSize.b3(toLong(2));
      }
      // Inline function 'kotlin.check' call
      if (!(_this__u8e3s4.o1g().s().e1(new Long(2147483647, 0)) < 0)) {
        var message = "Can't create an array of size " + _this__u8e3s4.o1g().s().toString();
        throw IllegalStateException_init_$Create$(toString(message));
      }
      arraySize = _this__u8e3s4.o1g().s().j1();
    } else {
      _this__u8e3s4.q1g(toLong(size));
    }
    var array = new Int8Array(arraySize);
    readTo(_this__u8e3s4.o1g(), array);
    return array;
  }
  function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
    ...
    while (offset < endIndex) {
      var bytesRead = _this__u8e3s4.n1h(sink, offset, endIndex);
      if (bytesRead === -1) {
  ...
  function readString(_this__u8e3s4) {
    _this__u8e3s4.r1g(new Long(-1, 2147483647));
    return commonReadUtf8(_this__u8e3s4.o1g(), _this__u8e3s4.o1g().s());
  }
  function readString_0(_this__u8e3s4, byteCount) {
    _this__u8e3s4.q1g(byteCount);
    return commonReadUtf8(_this__u8e3s4.o1g(), byteCount);
  }
  ...
  function commonReadUtf8(_this__u8e3s4, byteCount) {
    if (byteCount.equals(new Long(0, 0)))
      return '';
    // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.forEachSegment' call
    var curr = _this__u8e3s4.l1g_1;
    while (!(curr == null)) {
      get_SegmentReadContextImpl();
      if (toLong(curr.s()).e1(byteCount) >= 0) {
        var result = '';
        // Inline function 'kotlinx.io.unsafe.withData' call
        var tmp2 = curr.e1j(true);
        var tmp3 = curr.u1g_1;
        var tmp0 = curr.v1g_1;
    ...
    while (i < endIndex) {
      ...
      if (c < 128) {
        $l$block_0: {
          ...
          ctx.m1j(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
          $l$loop: while (i < runLimit) {
            ...
            ctx.m1j(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
          }
          var bytesWritten = i + segmentOffset | 0;
          if (bytesWritten === 1) {
            tail.v1g_1 = tail.v1g_1 + bytesWritten | 0;
            var tmp = this_0;
            // Inline function 'kotlin.Long.plus' call
            tmp.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten));
            break $l$block_0;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten ? bytesWritten <= tail.z1h() : false)) {
            var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.z1h();
            throw IllegalStateException_init_$Create$(toString(message));
          }
          if (!(bytesWritten === 0)) {
            tail.v1g_1 = tail.v1g_1 + bytesWritten | 0;
            var tmp_0 = this_0;
            // Inline function 'kotlin.Long.plus' call
            tmp_0.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten));
            break $l$block_0;
          }
          if (isEmpty(tail)) {
            this_0.o1i();
        ...
        $l$block_2: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_0 = this_0.u1h(2);
          get_SegmentWriteContextImpl().l1j(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
          var bytesWritten_0 = 2;
          if (bytesWritten_0 === 2) {
            tail_0.v1g_1 = tail_0.v1g_1 + bytesWritten_0 | 0;
            var tmp_1 = this_0;
            // Inline function 'kotlin.Long.plus' call
            tmp_1.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten_0));
            break $l$block_2;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.z1h() : false)) {
            var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.z1h();
          ...
          if (!(bytesWritten_0 === 0)) {
            ...
            var tmp_2 = this_0;
            // Inline function 'kotlin.Long.plus' call
            tmp_2.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten_0));
            break $l$block_2;
          }
          if (isEmpty(tail_0)) {
            this_0.o1i();
        ...
        $l$block_4: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_1 = this_0.u1h(3);
          get_SegmentWriteContextImpl().k1j(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
          var bytesWritten_1 = 3;
          if (bytesWritten_1 === 3) {
            tail_1.v1g_1 = tail_1.v1g_1 + bytesWritten_1 | 0;
            var tmp_3 = this_0;
            // Inline function 'kotlin.Long.plus' call
            tmp_3.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten_1));
            break $l$block_4;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.z1h() : false)) {
            var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.z1h();
            throw IllegalStateException_init_$Create$(toString(message_1));
          }
          if (!(bytesWritten_1 === 0)) {
            tail_1.v1g_1 = tail_1.v1g_1 + bytesWritten_1 | 0;
            var tmp_4 = this_0;
            // Inline function 'kotlin.Long.plus' call
            tmp_4.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten_1));
            break $l$block_4;
          }
          if (isEmpty(tail_1)) {
            this_0.o1i();
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          this_0.i1i(toByte(tmp$ret$26));
          i = i + 1 | 0;
        } else {
          var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
          $l$block_6: {
            // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
            var tail_2 = this_0.u1h(4);
            get_SegmentWriteContextImpl().j1j(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
            var bytesWritten_2 = 4;
            if (bytesWritten_2 === 4) {
              tail_2.v1g_1 = tail_2.v1g_1 + bytesWritten_2 | 0;
              var tmp_6 = this_0;
              // Inline function 'kotlin.Long.plus' call
              tmp_6.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten_2));
              break $l$block_6;
            }
            // Inline function 'kotlin.check' call
            if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.z1h() : false)) {
              var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.z1h();
            ...
            if (!(bytesWritten_2 === 0)) {
              ...
              var tmp_7 = this_0;
              // Inline function 'kotlin.Long.plus' call
              tmp_7.n1g_1 = this_0.n1g_1.z2(toLong(bytesWritten_2));
              break $l$block_6;
            }
            if (isEmpty(tail_2)) {
              this_0.o1i();
  ...
  protoOf(SegmentReadContextImpl$1).m1i = function (segment, offset) {
    return segment.l1h(offset);
  };
  function SegmentWriteContextImpl$1() {
  }
  protoOf(SegmentWriteContextImpl$1).m1j = function (segment, offset, value) {
    segment.f1j(offset, value);
  };
  protoOf(SegmentWriteContextImpl$1).l1j = function (segment, offset, b0, b1) {
    segment.g1j(offset, b0, b1);
  };
  protoOf(SegmentWriteContextImpl$1).k1j = function (segment, offset, b0, b1, b2) {
    segment.h1j(offset, b0, b1, b2);
  };
  protoOf(SegmentWriteContextImpl$1).j1j = function (segment, offset, b0, b1, b2, b3) {
    segment.i1j(offset, b0, b1, b2, b3);
  };
  function BufferIterationContextImpl$1() {
  }
  protoOf(BufferIterationContextImpl$1).m1i = function (segment, offset) {
    return get_SegmentReadContextImpl().m1i(segment, offset);
  };
  ...
  protoOf(SegmentPool).x1h = function () {
    return Companion_instance.a1j();
  };
  protoOf(SegmentPool).n1i = function (segment) {
  };
  protoOf(SegmentPool).c1j = function () {
  ...
  protoOf(Buffer).b1i = write$default;
  //endregion
  //region block: init
