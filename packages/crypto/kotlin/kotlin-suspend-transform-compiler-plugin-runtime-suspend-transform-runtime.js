(function (factory) {
  ...
  protoOf($runInAsync$$slambda).z1f = function ($this$promise, $completion) {
    var tmp = this.a1g($this$promise, $completion);
    tmp.n9_1 = Unit_instance;
    tmp.o9_1 = null;
    return tmp.da();
  };
  protoOf($runInAsync$$slambda).ta = function (p1, $completion) {
    return this.z1f((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf($runInAsync$$slambda).da = function () {
  ...
  protoOf($runInAsync$$slambda).a1g = function ($this$promise, completion) {
    var i = new $runInAsync$$slambda(this.x1f_1, completion);
    i.y1f_1 = $this$promise;
    return i;
  };
  function $runInAsync$$slambda_0($block, resultContinuation) {
    var i = new $runInAsync$$slambda($block, resultContinuation);
    var l = function ($this$promise, $completion) {
      return i.z1f($this$promise, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  function _init_properties_RunInSuspendJs_kt__7srfl7() {
    if (!properties_initialized_RunInSuspendJs_kt_c7ufpz) {
      ...
      CoroutineContext4Js = Dispatchers_getInstance().w12_1.ej(SupervisorJob());
