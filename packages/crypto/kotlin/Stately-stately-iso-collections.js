(function (factory) {
  ...
  function IsoMutableCollection$iterator$lambda(this$0) {
    return function (it) {
      return new IsoMutableIterator(this$0.z67(it.p()));
    };
  }
  ...
  protoOf(IsoMutableCollection).equals = function (other) {
    return this.a68(IsoMutableCollection$equals$lambda(other));
  };
  protoOf(IsoMutableCollection).hashCode = function () {
    return this.a68(IsoMutableCollection$hashCode$lambda);
  };
  protoOf(IsoMutableCollection).s = function () {
    return this.a68(IsoMutableCollection$_get_size_$lambda_ojq7a4);
  };
  protoOf(IsoMutableCollection).ph = function (element) {
    return this.a68(IsoMutableCollection$contains$lambda(element));
  };
  protoOf(IsoMutableCollection).x1 = function (element) {
    if (!(element == null ? true : !(element == null)))
      return false;
    return this.ph((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  protoOf(IsoMutableCollection).qh = function (elements) {
    return this.a68(IsoMutableCollection$containsAll$lambda(elements));
  };
  protoOf(IsoMutableCollection).y1 = function (elements) {
    return this.qh(elements);
  };
  protoOf(IsoMutableCollection).h = function () {
    return this.a68(IsoMutableCollection$isEmpty$lambda);
  };
  protoOf(IsoMutableCollection).c68 = function (element) {
    return this.a68(IsoMutableCollection$add$lambda(element));
  };
  protoOf(IsoMutableCollection).n = function (element) {
    return this.c68((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  protoOf(IsoMutableCollection).d68 = function (elements) {
    return this.a68(IsoMutableCollection$addAll$lambda(elements));
  };
  protoOf(IsoMutableCollection).t = function (elements) {
    return this.d68(elements);
  };
  protoOf(IsoMutableCollection).e2 = function () {
    return this.a68(IsoMutableCollection$clear$lambda);
  };
  protoOf(IsoMutableCollection).p = function () {
    return this.a68(IsoMutableCollection$iterator$lambda(this));
  };
  protoOf(IsoMutableCollection).e68 = function (element) {
    return this.a68(IsoMutableCollection$remove$lambda(element));
  };
  protoOf(IsoMutableCollection).d2 = function (element) {
    if (!(element == null ? true : !(element == null)))
      return false;
    return this.e68((element == null ? true : !(element == null)) ? element : THROW_CCE());
  };
  ...
  protoOf(IsoMutableIterator).q = function () {
    return this.a68(IsoMutableIterator$hasNext$lambda);
  };
  protoOf(IsoMutableIterator).r = function () {
    return this.a68(IsoMutableIterator$next$lambda);
  };
  protoOf(IsoMutableIterator).r4 = function () {
    return this.a68(IsoMutableIterator$remove$lambda);
  };
  ...
  function IsoMutableMap$_get_keys_$lambda_z6b79x(this$0) {
    return function (it) {
      return new IsoMutableSet(this$0.z67(it.l2()));
    };
  }
  function IsoMutableMap$_get_values_$lambda_waxbzb(this$0) {
    return function (it) {
      return new IsoMutableCollection(this$0.z67(it.m2()));
    };
  }
  ...
  protoOf(IsoMutableMap).s = function () {
    return this.a68(IsoMutableMap$_get_size_$lambda_5ut66g);
  };
  protoOf(IsoMutableMap).i2 = function (key) {
    return this.a68(IsoMutableMap$containsKey$lambda(key));
  };
  protoOf(IsoMutableMap).j2 = function (value) {
    return this.a68(IsoMutableMap$containsValue$lambda(value));
  };
  protoOf(IsoMutableMap).k2 = function (key) {
    return this.a68(IsoMutableMap$get$lambda(key));
  };
  protoOf(IsoMutableMap).h = function () {
    return this.a68(IsoMutableMap$isEmpty$lambda);
  };
  ...
  protoOf(IsoMutableMap).l2 = function () {
    return this.a68(IsoMutableMap$_get_keys_$lambda_z6b79x(this));
  };
  protoOf(IsoMutableMap).m2 = function () {
    return this.a68(IsoMutableMap$_get_values_$lambda_waxbzb(this));
  };
  protoOf(IsoMutableMap).e2 = function () {
    return this.a68(IsoMutableMap$clear$lambda);
  };
  protoOf(IsoMutableMap).n2 = function (key, value) {
    return this.a68(IsoMutableMap$put$lambda(key, value));
  };
  protoOf(IsoMutableMap).p2 = function (from) {
    return this.a68(IsoMutableMap$putAll$lambda(from));
  };
  protoOf(IsoMutableMap).o2 = function (key) {
    return this.a68(IsoMutableMap$remove$lambda(key));
  };
  protoOf(IsoMutableMap).equals = function (other) {
    return this.a68(IsoMutableMap$equals$lambda(other));
  };
  protoOf(IsoMutableMap).hashCode = function () {
    return this.a68(IsoMutableMap$hashCode$lambda);
  };
