(function (factory) {
  ...
  function Companion() {
    ...
    while (_iterator__ex2g4s.q()) {
      ...
      var tmp$ret$0 = element.q3e_1;
      destination.p2(tmp$ret$0, element);
    }
    tmp.r3e_1 = destination;
    this.s3e_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).t3e = function (code) {
    return this.r3e_1.m2(code);
  };
  ...
  protoOf(CloseReason).w3e = function () {
    return Companion_getInstance().t3e(this.u3e_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.w3e();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.u3e_1 : tmp0_elvis_lhs) + ', message=' + this.v3e_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.u3e_1;
    result = imul(result, 31) + getStringHashCode(this.v3e_1) | 0;
    return result;
  };
  ...
  function Companion_0() {
    ...
    tmp.b3f_1 = ensureNotNull(tmp$ret$0).a3f_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.b3f_1 + 1 | 0;
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    builder.k1l(reason.u3e_1);
    writeText(builder, reason.v3e_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().d3f_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.e3f_1 = fin;
    this.f3f_1 = frameType;
    this.g3f_1 = data;
    this.h3f_1 = disposableHandle;
    this.i3f_1 = rsv1;
    this.j3f_1 = rsv2;
    this.k3f_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.f3f_1.toString() + ' (fin=' + this.e3f_1 + ', buffer len = ' + this.g3f_1.length + ')';
  };
  //region block: init
