(function (factory) {
  ...
  protoOf($runInAsync$$slambda).z1i = function ($this$promise, $completion) {
  ...
  protoOf($runInAsync$$slambda).a1j = function ($this$promise, completion) {
    var i = new $runInAsync$$slambda(this.x1i_1, completion);
    i.y1i_1 = $this$promise;
    return i;
  };
  function $runInAsync$$slambda_0($block, resultContinuation) {
    var i = new $runInAsync$$slambda($block, resultContinuation);
    var l = function ($this$promise, $completion) {
      return i.z1i($this$promise, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  function _init_properties_RunInSuspendJs_kt__7srfl7() {
    if (!properties_initialized_RunInSuspendJs_kt_c7ufpz) {
      ...
      CoroutineContext4Js = Dispatchers_getInstance().d14_1.xj(SupervisorJob());
