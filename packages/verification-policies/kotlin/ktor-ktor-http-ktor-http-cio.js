(function (factory) {
  ...
  var SequenceScope = kotlin_kotlin.$_$.ze;
  ...
  var toLongArray = kotlin_kotlin.$_$.xa;
  ...
  function CIOMultipartDataBase(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.h38_1 = coroutineContext;
    this.i38_1 = null;
    this.j38_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  protoOf(CIOMultipartDataBase).ps = function () {
    return this.h38_1;
  };
  ...
  protoOf(HeadersData$headersStarts$slambda).y38 = function ($this$sequence, $completion) {
    var tmp = this.z38($this$sequence, $completion);
    tmp.p9_1 = Unit_instance;
    tmp.q9_1 = null;
    return tmp.fa();
  };
  protoOf(HeadersData$headersStarts$slambda).va = function (p1, $completion) {
    return this.y38(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.w38_1 = this.v38_1.r();
            this.x38_1 = 0;
            this.n9_1 = 2;
            continue $sm;
          case 2:
            if (!(this.x38_1 < this.w38_1.length)) {
              this.n9_1 = 5;
              continue $sm;
            }

            if (!(this.s38_1.b39(this.u38_1 + 0 | 0) === -1)) {
              this.n9_1 = 3;
              suspendResult = this.t38_1.ki(this.u38_1, this);
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            this.x38_1 = this.x38_1 + 6 | 0;
            this.u38_1 = this.u38_1 + 6 | 0;
            this.n9_1 = 2;
            continue $sm;
          case 5:
            this.n9_1 = 1;
  ...
  protoOf(HeadersData$headersStarts$slambda).z38 = function ($this$sequence, completion) {
    var i = new HeadersData$headersStarts$slambda(this.s38_1, completion);
    i.t38_1 = $this$sequence;
    return i;
  };
  function HeadersData$headersStarts$slambda_0(this$0, resultContinuation) {
    ...
    var l = function ($this$sequence, $completion) {
      return i.y38($this$sequence, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  protoOf(HeadersData).c39 = function () {
    return this.a39_1.s();
  };
  protoOf(HeadersData).d39 = function (subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.a39_1.n(get_IntArrayPool().g20());
      }
       while (inductionVariable < subArraysCount);
  };
  protoOf(HeadersData).b39 = function (index) {
    return this.a39_1.u(index / 768 | 0)[index % 768 | 0];
  };
  protoOf(HeadersData).e39 = function (index, value) {
    this.a39_1.u(index / 768 | 0)[index % 768 | 0] = value;
  };
  protoOf(HeadersData).f39 = function () {
    return sequence(HeadersData$headersStarts$slambda_0(this, null));
  };
  protoOf(HeadersData).i1g = function () {
    var _iterator__ex2g4s = this.a39_1.p();
    while (_iterator__ex2g4s.q()) {
      var array = _iterator__ex2g4s.r();
      get_IntArrayPool().h20(array);
    }
    this.a39_1.g2();
  };
  function thresholdReached($this) {
    return $this.h39_1 >= $this.i39_1 * 0.75;
  }
  function resize($this) {
    var prevSize = $this.h39_1;
    var prevData = $this.j39_1;
    $this.h39_1 = 0;
    $this.i39_1 = imul($this.i39_1, 2) | 128;
    var tmp = $this;
    // Inline function 'kotlin.apply' call
    var this_0 = get_HeadersDataPool().g20();
    this_0.d39(imul(prevData.c39(), 2) | 1);
    tmp.j39_1 = this_0;
    var _iterator__ex2g4s = prevData.f39().p();
    while (_iterator__ex2g4s.q()) {
      var headerOffset = _iterator__ex2g4s.r();
      $this.k39(prevData.b39(headerOffset + 1 | 0), prevData.b39(headerOffset + 2 | 0), prevData.b39(headerOffset + 3 | 0), prevData.b39(headerOffset + 4 | 0));
    }
    get_HeadersDataPool().h20(prevData);
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.require' call
    if (!(prevSize === $this.h39_1)) {
      var message = 'Failed requirement.';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  function headerHasName($this, name, headerOffset) {
    var nameStartIndex = $this.j39_1.b39(headerOffset + 1 | 0);
    var nameEndIndex = $this.j39_1.b39(headerOffset + 2 | 0);
    return equalsLowerCase($this.g39_1, nameStartIndex, nameEndIndex, name);
  }
  function HttpHeadersMap(builder) {
    this.g39_1 = builder;
    this.h39_1 = 0;
    this.i39_1 = 0;
    this.j39_1 = get_HeadersDataPool().g20();
  }
  protoOf(HttpHeadersMap).af = function (name) {
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.i39_1 | 0;
    while (!(this.j39_1.b39(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.l39(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.i39_1 | 0;
    }
    return null;
  };
  protoOf(HttpHeadersMap).m39 = function () {
    return this.j39_1.f39();
  };
  protoOf(HttpHeadersMap).k39 = function (nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.g39_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.g39_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.i39_1 | 0;
    ...
    this.j39_1.e39(headerOffset + 0 | 0, hash);
    this.j39_1.e39(headerOffset + 1 | 0, nameStartIndex);
    this.j39_1.e39(headerOffset + 2 | 0, nameEndIndex);
    this.j39_1.e39(headerOffset + 3 | 0, valueStartIndex);
    this.j39_1.e39(headerOffset + 4 | 0, valueEndIndex);
    this.j39_1.e39(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.j39_1.e39(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.h39_1 = this.h39_1 + 1 | 0;
  };
  protoOf(HttpHeadersMap).u39 = function (headerOffset) {
    var nameStartIndex = this.j39_1.b39(headerOffset + 1 | 0);
    var nameEndIndex = this.j39_1.b39(headerOffset + 2 | 0);
    return this.g39_1.c(nameStartIndex, nameEndIndex);
  };
  protoOf(HttpHeadersMap).l39 = function (headerOffset) {
    var valueStartIndex = this.j39_1.b39(headerOffset + 3 | 0);
    var valueEndIndex = this.j39_1.b39(headerOffset + 4 | 0);
    return this.g39_1.c(valueStartIndex, valueEndIndex);
  };
  protoOf(HttpHeadersMap).i1g = function () {
    this.h39_1 = 0;
    this.i39_1 = 0;
    get_HeadersDataPool().h20(this.j39_1);
    this.j39_1 = get_HeadersDataPool().g20();
  };
  ...
  function dumpTo(_this__u8e3s4, indent, out) {
    _init_properties_HttpHeadersMap_kt__hwatby();
    var _iterator__ex2g4s = _this__u8e3s4.m39().p();
    while (_iterator__ex2g4s.q()) {
      var offset = _iterator__ex2g4s.r();
      out.o(indent);
      out.o(_this__u8e3s4.u39(offset));
      out.o(' => ');
      out.o(_this__u8e3s4.l39(offset));
      out.o('\n');
    }
  }
  ...
  protoOf(IntArrayPool$1).z1z = function () {
    var tmp = 0;
  ...
  protoOf(IntArrayPool$1).y39 = function (instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).e20.call(this, instance);
  };
  protoOf(IntArrayPool$1).e20 = function (instance) {
    return this.y39(isIntArray(instance) ? instance : THROW_CCE());
  };
  function HeadersDataPool$1() {
    DefaultPool.call(this, 1000);
  }
  protoOf(HeadersDataPool$1).z1z = function () {
    return new HeadersData();
  };
  protoOf(HeadersDataPool$1).c3a = function (instance) {
    instance.i1g();
    return protoOf(DefaultPool).e20.call(this, instance);
  };
  protoOf(HeadersDataPool$1).e20 = function (instance) {
    return this.c3a(instance instanceof HeadersData ? instance : THROW_CCE());
  };
  ...
  function parseHeaderName(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var index = range.p3a_1;
    var end = range.q3a_1;
    while (index < end) {
      var ch = text.b(index);
      if (ch === _Char___init__impl__6a9atx(58) && !(index === range.p3a_1)) {
        range.p3a_1 = index + 1 | 0;
        return index;
      }
      if (isDelimiter(ch)) {
        parseHeaderNameFailed(text, index, range.p3a_1, ch);
      }
      index = index + 1 | 0;
    }
  ...
  function parseHeaderValue(text, range) {
    ...
    range.p3a_1 = valueStart;
    range.q3a_1 = valueLastIndex + 1 | 0;
  }
  ...
  function noColonFound(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var tmp1 = range.p3a_1;
    // Inline function 'kotlin.text.substring' call
    var endIndex = range.q3a_1;
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o9_1 = 7;
            this.o3a_1 = new HttpHeadersMap(this.m3a_1);
            this.o9_1 = 6;
            this.n9_1 = 1;
            continue $sm;
          case 1:
            ...
            this.n9_1 = 2;
            suspendResult = readUTF8LineTo(this.l3a_1, this.m3a_1, 8192, get_httpLineEndings(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            this.n3a_1.q3a_1 = this.m3a_1.t39_1;
            var rangeLength = this.n3a_1.q3a_1 - this.n3a_1.p3a_1 | 0;
            if (rangeLength === 0) {
              this.n9_1 = 5;
              continue $sm;
            } else {
          ...
          case 4:
            ...
            var nameStart = this.n3a_1.p3a_1;
            var nameEnd = parseHeaderName(this.m3a_1, this.n3a_1);
            var headerEnd = this.n3a_1.q3a_1;
            parseHeaderValue(this.m3a_1, this.n3a_1);
            var valueStart = this.n3a_1.p3a_1;
            var valueEnd = this.n3a_1.q3a_1;
            this.n3a_1.p3a_1 = headerEnd;
            this.o3a_1.k39(nameStart, nameEnd, valueStart, valueEnd);
            this.n9_1 = 1;
            continue $sm;
          case 5:
            var host = this.o3a_1.af(HttpHeaders_getInstance().c2z_1);
            if (!(host == null)) {
  ...
  function _init_properties_HttpParser_kt__gbdom1() {
    if (!properties_initialized_HttpParser_kt_uedryv) {
      ...
      httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance().b1t_1, Companion_getInstance().a1t_1);
      versions = Companion_instance.r3a(listOf(['HTTP/1.0', 'HTTP/1.1']));
    }
  }
  function get_CrLf() {
  ...
  function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
    ...
    _init_properties_Multipart_kt__ato98a();
    if (!MultiPart_getInstance().s2w(contentType)) {
  ...
  function parseMultipart$slambda$slambda($firstBoundary, $countedInput, resultContinuation) {
    this.r3c_1 = $firstBoundary;
    this.s3c_1 = $countedInput;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda$slambda).u3c = function ($this$writer, $completion) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o9_1 = 3;
            this.n9_1 = 1;
            suspendResult = parsePreambleImpl(this.r3c_1, this.s3c_1, this.t3c_1.e1x_1, new Long(8193, 0), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            this.n9_1 = 2;
            suspendResult = this.t3c_1.e1x_1.f1p(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda$slambda).v3c = function ($this$writer, completion) {
    var i = new parseMultipart$slambda$slambda(this.r3c_1, this.s3c_1, completion);
    i.t3c_1 = $this$writer;
    return i;
  };
  ...
  function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    this.e3d_1 = $input;
    this.f3d_1 = $boundaryPrefixed;
    this.g3d_1 = $maxPartSize;
    this.h3d_1 = $totalLength;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda).z3d = function ($this$produce, $completion) {
    var tmp = this.a3e($this$produce, $completion);
    tmp.p9_1 = Unit_instance;
    tmp.q9_1 = null;
    return tmp.fa();
  };
  protoOf(parseMultipart$slambda).va = function (p1, $completion) {
    return this.z3d((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  };
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o9_1 = 23;
            this.j3d_1 = counted(this.e3d_1);
            this.k3d_1 = this.j3d_1.n1z();
            this.l3d_1 = this.f3d_1.h1j(get_PrefixString().s());
            this.n9_1 = 1;
            suspendResult = readRemaining(writer(this.i3d_1, VOID, VOID, parseMultipart$slambda$slambda_0(this.l3d_1, this.j3d_1, null)).c1x_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 1:
            this.m3d_1 = suspendResult;
            if (get_remaining(this.m3d_1).g1(new Long(0, 0)) > 0) {
              this.n9_1 = 2;
              suspendResult = this.i3d_1.t19(new Preamble(this.m3d_1), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            if (!this.j3d_1.c1p()) {
              this.n9_1 = 5;
              suspendResult = skipIfFound(this.j3d_1, get_PrefixString(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 6:
            ...
            this.n9_1 = 7;
            suspendResult = skipIfFound(this.j3d_1, get_CrLf(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 7:
            this.p3d_1 = new ByteChannel();
            this.q3d_1 = CompletableDeferred();
            this.r3d_1 = new MultipartPart(this.q3d_1, this.p3d_1);
            this.n9_1 = 8;
            suspendResult = this.i3d_1.t19(this.r3d_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 8:
            ...
            this.o9_1 = 12;
            this.n9_1 = 9;
            suspendResult = parsePartHeadersImpl(this.j3d_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 9:
            ...
            if (!this.q3d_1.j10(this.s3d_1)) {
              this.s3d_1.i1g();
              throw CancellationException_init_$Create$('Multipart processing has been cancelled');
            }

            this.n9_1 = 10;
            suspendResult = parsePartBodyImpl(this.f3d_1, this.j3d_1, this.p3d_1, this.s3d_1, this.g3d_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 12:
            ...
            var tmp_0 = this.q9_1;
            if (tmp_0 instanceof Error) {
              this.t3d_1 = this.q9_1;
              if (this.q3d_1.l10(this.t3d_1)) {
          ...
          case 15:
            if (!(this.h3d_1 == null)) {
              this.u3d_1 = this.j3d_1.n1z().c3(this.k3d_1);
              this.v3d_1 = this.h3d_1.c3(this.u3d_1);
              if (this.v3d_1.g1(new Long(2147483647, 0)) > 0)
                throw IOException_init_$Create$('Failed to parse multipart: prologue is too long');
              if (this.v3d_1.g1(new Long(0, 0)) > 0) {
                this.n9_1 = 19;
                suspendResult = readPacket(this.j3d_1, this.v3d_1.l1(), this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
              ...
              this.n9_1 = 16;
              suspendResult = readRemaining(this.j3d_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 16:
            ...
            if (!this.w3d_1.p1j()) {
              this.n9_1 = 17;
              suspendResult = this.i3d_1.t19(new Epilogue(this.w3d_1), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 19:
            ...
            this.y3d_1 = new Epilogue(this.x3d_1);
            this.n9_1 = 20;
            suspendResult = this.i3d_1.t19(this.y3d_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda).a3e = function ($this$produce, completion) {
    var i = new parseMultipart$slambda(this.e3d_1, this.f3d_1, this.g3d_1, this.h3d_1, completion);
    i.i3d_1 = $this$produce;
    return i;
  };
  function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    ...
    var l = function ($this$produce, $completion) {
      return i.z3d($this$produce, $completion);
    };
    l.$arity = 1;
    return l;
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o9_1 = 3;
            this.f3b_1 = new CharArrayBuilder();
            this.o9_1 = 2;
            this.n9_1 = 1;
            suspendResult = parseHeaders(this.e3b_1, this.f3b_1, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o9_1 = 6;
            var tmp_0 = this;
            var tmp0_safe_receiver = this.r3b_1.af('Content-Length');
            tmp_0.t3b_1 = tmp0_safe_receiver == null ? null : parseDecLong(tmp0_safe_receiver);
            if (this.t3b_1 == null) {
              this.n9_1 = 3;
              suspendResult = readUntil(this.p3b_1, this.o3b_1, this.q3b_1, this.s3b_1, true, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              if ((new Long(0, 0)).k3(this.s3b_1).gm(this.t3b_1)) {
                this.n9_1 = 1;
                suspendResult = copyTo(this.p3b_1, this.q3b_1, this.t3b_1, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
                ...
                var tmp_1 = this;
                throwLimitExceeded(this.t3b_1, this.s3b_1);
              }
            }
          ...
          case 1:
            ...
            this.n9_1 = 2;
            suspendResult = skipIfFoundReadCount(this.p3b_1, this.o3b_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            ...
            this.u3b_1 = this.v3b_1.b3(this.w3b_1);
            this.n9_1 = 4;
            continue $sm;
          case 3:
            ...
            continue $sm;
          case 4:
            this.x3b_1 = this.u3b_1;
            this.n9_1 = 5;
            suspendResult = this.q3b_1.u1o(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o9_1 = 3;
            this.n9_1 = 1;
            suspendResult = skipIfFound(this.g3c_1, this.h3c_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            if (suspendResult) {
              var tmp_0 = this;
              tmp_0.i3c_1 = toLong(this.h3c_1.s());
              this.n9_1 = 2;
              continue $sm;
            } else {
              var tmp_1 = this;
              tmp_1.i3c_1 = new Long(0, 0);
              this.n9_1 = 2;
              continue $sm;
            }
  ...
  protoOf(Companion).r3a = function (from) {
    var tmp = AsciiCharTree$Companion$build$lambda;
    return this.f3e(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  };
  protoOf(Companion).f3e = function (from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
  ...
  function getImpl($this, index) {
    return bufferForIndex($this, index)[index % ensureNotNull($this.p39_1).length | 0];
  }
  ...
  protoOf(SubSequenceImpl).a = function () {
    return this.i3e_1 - this.h3e_1 | 0;
  };
  protoOf(SubSequenceImpl).b = function (index) {
    var withOffset = index + this.h3e_1 | 0;
    // Inline function 'kotlin.require' call
    if (!(index >= 0)) {
  ...
  protoOf(SubSequenceImpl).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.i3e_1 - this.h3e_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.k3e_1, this.h3e_1 + startIndex | 0, this.h3e_1 + endIndex | 0);
  };
  protoOf(SubSequenceImpl).toString = function () {
    var tmp0_elvis_lhs = this.j3e_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.k3e_1, this.h3e_1, this.i3e_1));
      this.j3e_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(SubSequenceImpl).equals = function (other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.k3e_1, this.h3e_1, other, 0, this.a());
  };
  protoOf(SubSequenceImpl).hashCode = function () {
    var tmp0_safe_receiver = this.j3e_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.k3e_1, this.h3e_1, this.i3e_1) : tmp1_elvis_lhs;
  };
  function bufferForIndex($this, index) {
    ...
    return list.u(index / ensureNotNull($this.p39_1).length | 0);
  }
  ...
  function nonFullBuffer($this) {
    return $this.s39_1 === 0 ? appendNewArray($this) : ensureNotNull($this.p39_1);
  }
  function appendNewArray($this) {
    var newBuffer = $this.n39_1.g20();
    var existing = $this.p39_1;
    $this.p39_1 = newBuffer;
    $this.s39_1 = newBuffer.length;
    $this.r39_1 = false;
    if (!(existing == null)) {
      var tmp0_elvis_lhs = $this.o39_1;
      var tmp;
      if (tmp0_elvis_lhs == null) {
        // Inline function 'kotlin.also' call
  ...
  function currentPosition($this) {
    return ensureNotNull($this.p39_1).length - $this.s39_1 | 0;
  }
  ...
  protoOf(CharArrayBuilder).b = function (index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.t39_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.t39_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  ...
  protoOf(CharArrayBuilder).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.t39_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.t39_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
  ...
  protoOf(CharArrayBuilder).toString = function () {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.t39_1));
      this.q39_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(CharArrayBuilder).equals = function (other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.t39_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.t39_1);
  };
  protoOf(CharArrayBuilder).hashCode = function () {
    var tmp0_safe_receiver = this.q39_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.t39_1) : tmp1_elvis_lhs;
  };
  protoOf(CharArrayBuilder).z8 = function (value) {
    nonFullBuffer(this)[ensureNotNull(this.p39_1).length - this.s39_1 | 0] = value;
    this.q39_1 = null;
    this.s39_1 = this.s39_1 - 1 | 0;
  ...
  protoOf(CharArrayBuilder).xd = function (value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.s39_1 | 0;
      ...
      this.s39_1 = this.s39_1 - bytesToCopy | 0;
    }
    this.q39_1 = null;
    this.t39_1 = this.t39_1 + (endIndex - startIndex | 0) | 0;
    return this;
  };
  ...
  protoOf(CharArrayBuilder).i1g = function () {
    var list = this.o39_1;
    if (!(list == null)) {
      this.p39_1 = null;
      var inductionVariable = 0;
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.n39_1.h20(tmp0_safe_receiver);
      }
      this.p39_1 = null;
    }
    this.r39_1 = true;
  ...
  protoOf(CharArrayPool$1).g20 = function () {
    return charArray(2048);
  };
  function CharArrayPool$2() {
    DefaultPool.call(this, 4096);
  }
  protoOf(CharArrayPool$2).z1z = function () {
    return charArray(2048);
  };
  ...
  function DefaultHttpMethods$lambda(it) {
    _init_properties_Chars_kt__d3i39x();
    return it.k32_1.length;
  }
  function DefaultHttpMethods$lambda_0(m, idx) {
    _init_properties_Chars_kt__d3i39x();
    return new Char(charSequenceGet(m.k32_1, idx));
  }
  ...
  function _init_properties_Chars_kt__d3i39x() {
    if (!properties_initialized_Chars_kt_phjfhp) {
      ...
      var tmp_0 = Companion_getInstance_0().j32_1;
      var tmp_1 = DefaultHttpMethods$lambda;
      DefaultHttpMethods = tmp.f3e(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
  ...
  protoOf(MutableRange).toString = function () {
    return 'MutableRange(start=' + this.p3a_1 + ', end=' + this.q3a_1 + ')';
  };
