(function (factory) {
  ...
  protoOf(KotlinxJsonNode).za0 = function () {
    return this.ge5_1;
  };
  protoOf(KotlinxJsonNode).ie4 = function () {
    var tmp = this.ge4_1;
    return tmp instanceof JsonArray ? tmp : THROW_CCE();
  };
  protoOf(KotlinxJsonNode).je4 = function () {
    var tmp = this.ge4_1;
    return tmp instanceof JsonObject ? tmp : THROW_CCE();
  };
  protoOf(KotlinxJsonNode).ke4 = function () {
    var tmp = this.ge4_1;
    return (tmp instanceof JsonObject ? tmp : THROW_CCE()).o2();
  };
  protoOf(KotlinxJsonNode).le4 = function () {
    var tmp = this.ge4_1;
    // Inline function 'kotlin.with' call
    var $this$with = tmp instanceof JsonPrimitive ? tmp : THROW_CCE();
    return $this$with.p4u() ? get_contentOrNull($this$with) : null;
  };
  protoOf(KotlinxJsonNode).me4 = function () {
    return get_defaultEmptyJsonArray();
  };
  protoOf(KotlinxJsonNode).ne4 = function (_this__u8e3s4) {
    var tmp;
  ...
  protoOf(KotlinxJsonNode).re4 = function (content) {
    return JsonPrimitive_0(content);
  };
  protoOf(KotlinxJsonNode).se4 = function (list) {
    return new JsonArray(isInterface(list, KtList) ? list : THROW_CCE());
  };
  protoOf(KotlinxJsonNode).te4 = function (element, isWildcardScope) {
  ...
  function resolveOrNull(_this__u8e3s4, path, options) {
    options = options === VOID ? Companion_getInstance().ce4_1 : options;
  ...
  function resolveOrNull_0(_this__u8e3s4, json, options) {
    ...
    var _iterator__ex2g4s = _JsonPath___get_tokens__impl__ney223(_this__u8e3s4).p();
    while (_iterator__ex2g4s.q()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        tmp = element.we4(tmp0_safe_receiver);
      }
      accumulator = tmp;
    }
    ...
    if (tmp0_safe_receiver_0 == null) {
      ...
      var isNodeAnArray = tmp0_safe_receiver_0.za0().equals(JsonType_Array_getInstance());
      var wrappingRequired = options.de4_1 && !containsWildcard && (isRoot || isAccessingAnObjectOrArray || !isNodeAnArray);
      tmp_0 = wrappingRequired ? tmp0_safe_receiver_0.ue4(tmp0_safe_receiver_0.se4(listOf(tmp0_safe_receiver_0.ge4_1))) : tmp0_safe_receiver_0;
    }
    var tmp1_safe_receiver = tmp_0;
    var tmp_3 = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.ge4_1;
