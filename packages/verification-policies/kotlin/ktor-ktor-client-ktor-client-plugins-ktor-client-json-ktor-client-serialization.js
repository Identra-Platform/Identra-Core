(function (factory) {
  ...
  function KotlinxSerializer$Companion$DefaultJson$lambda($this$Json) {
    ...
    $this$Json.y4s_1 = false;
    $this$Json.k4t_1 = true;
    $this$Json.m4t_1 = false;
    return Unit_instance;
  }
  function Companion() {
    Companion_instance = this;
    var tmp = this;
    tmp.z55_1 = Json(VOID, KotlinxSerializer$Companion$DefaultJson$lambda);
  }
  ...
  function KotlinxSerializer(json) {
    ...
    json = json === VOID ? Companion_getInstance().z55_1 : json;
    this.a56_1 = json;
  }
  var initializer;
