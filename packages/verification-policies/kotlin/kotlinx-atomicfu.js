(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).ds = function () {
    return this.cs_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.cs_1[index];
  };
  ...
  protoOf(AtomicRef).es = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).fs = function () {
  ...
  protoOf(AtomicBoolean).gs = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).fs = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).hs = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).fs = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).is = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).fs = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).ds);
  //endregion
