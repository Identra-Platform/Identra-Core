(function (factory) {
  ...
  var get_indices = kotlin_kotlin.$_$.gg;
  ...
  function Character() {
    ...
    this.q9t_1 = 65536;
    this.r9t_1 = -56613888;
    this.s9t_1 = _Char___init__impl__6a9atx(55232);
  }
  protoOf(Character).t9t = function (codePoint) {
    return 65536 <= codePoint ? codePoint <= 1114111 : false;
  };
  protoOf(Character).u9t = function (highSurrogate, lowSurrogate) {
    // Inline function 'kotlin.code' call
    var tmp = Char__toInt_impl_vasixd(highSurrogate) << 10;
    // Inline function 'kotlin.code' call
    return (tmp + Char__toInt_impl_vasixd(lowSurrogate) | 0) + -56613888 | 0;
  };
  protoOf(Character).v9t = function (codePoint) {
    return (codePoint >>> 16 | 0) === 0;
  };
  protoOf(Character).w9t = function (codePoint) {
  ...
  protoOf(Character).x9t = function (codePoint) {
  ...
  function appendEncodedDigit($this, _this__u8e3s4, digit) {
    _this__u8e3s4.z8($this.y9t_1[digit & 15]);
  }
  ...
  function codePointAt($this, _this__u8e3s4, index) {
    ...
    if (isHighSurrogate(firstChar)) {
      ...
      if (tmp === true) {
        return Character_getInstance().u9t(firstChar, nextChar);
      }
    }
    // Inline function 'kotlin.code' call
  ...
  function UrlEncoderUtil() {
    ...
    this.y9t_1 = toCharArray('0123456789ABCDEF');
    var tmp = this;
    // Inline function 'kotlin.code' call
  ...
  protoOf(UrlEncoderUtil).a9u = function (source, allow, spaceToPlus) {
      ...
      if (isUnreserved(this, ch) || contains(allow, ch)) {
        ...
        if (cp < 128) {
          if (spaceToPlus && ch === _Char___init__impl__6a9atx(32)) {
            out.z8(_Char___init__impl__6a9atx(43));
          } else {
            appendEncodedByte(this, out, cp);
          }
          i = i + 1 | 0;
        } else if (Character_getInstance().v9t(cp)) {
          ...
          i = i + 1 | 0;
        } else if (Character_getInstance().t9t(cp)) {
          var high = Character_getInstance().w9t(cp);
          var low = Character_getInstance().x9t(cp);
  ...
  protoOf(UrlEncoderUtil).b9u = function (source, allow, spaceToPlus, $super) {
    allow = allow === VOID ? '' : allow;
    spaceToPlus = spaceToPlus === VOID ? false : spaceToPlus;
    return $super === VOID ? this.a9u(source, allow, spaceToPlus) : $super.a9u.call(this, source, allow, spaceToPlus);
  };
