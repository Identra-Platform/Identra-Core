(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.m6j_1 = h;
    $this.n6j_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.o6j_1 = h.slice();
    $this.p6j_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).k6i = function (input, offset) {
    ...
    var k = Companion_getInstance().r6j_1;
    var state = this.o6j_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).e6i = function (buf, bufPos) {
    var digest = new Int8Array(this.y6h());
    this.i6i(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).i6i = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.p6j_1.w6i(bufPos).t6i();
    var bitsLo = tmp0_container.dc();
    var bitsHi = tmp0_container.ec();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.k6i(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().f6j(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().f6j(bitsLo, buf, 60);
    this.k6i(buf, 0);
    Big_getInstance();
    var tmp9 = this.o6j_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.y6h() / 4 | 0;
    Big_getInstance().g6j(tmp9, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).f6i = function () {
    fill_0(this.n6j_1, 0);
    var tmp0 = this.m6j_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.o6j_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().s6j_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.s6j_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
