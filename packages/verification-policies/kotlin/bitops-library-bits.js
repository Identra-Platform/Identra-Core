(function (factory) {
  ...
  protoOf(Final).dc = function () {
    return this.r6i_1;
  };
  protoOf(Final).ec = function () {
    return this.s6i_1;
  };
  protoOf(Final).t6i = function () {
    if (this.u6i_1)
      return this;
    return new Final(this.r6i_1 << 3, this.s6i_1 << 3 | (this.r6i_1 >>> 29 | 0), true);
  };
  function Final_0() {
  }
  protoOf(Bit32).v6i = function () {
    this.o6i_1 = this.o6i_1 + this.n6i_1 | 0;
    if (this.o6i_1 === 0) {
      this.p6i_1 = this.p6i_1 + 1 | 0;
    }
  };
  protoOf(Bit32).w6i = function (additional) {
    var lo = this.o6i_1;
    var hi = this.p6i_1;
    var lt0 = lo < 0;
    lo = lo + additional | 0;
  ...
  protoOf(Final_1).hashCode = function () {
    ...
    if (this instanceof Final) {
      result = imul(result, 31) + this.r6i_1 | 0;
      result = imul(result, 31) + this.s6i_1 | 0;
    } else {
      if (this instanceof Final_0) {
        result = imul(result, 31) + this.y6i_1.hashCode() | 0;
        result = imul(result, 31) + this.z6i_1.hashCode() | 0;
      }
    }
    result = imul(result, 31) + getBooleanHashCode(this.u6i_1) | 0;
    return result;
  };
  protoOf(Final_1).toString = function () {
    var tmp;
    if (this instanceof Final) {
      tmp = 'Counter.Bit32.Final[lo=' + this.r6i_1 + ', hi=' + this.s6i_1 + ']';
    } else {
      if (this instanceof Final_0) {
        tmp = 'Counter.Bit64.Final[lo=' + this.y6i_1.toString() + ', hi=' + this.z6i_1.toString() + ']';
      } else {
  ...
  protoOf(Counter).hashCode = function () {
    return 527 + hashCode(this.a6j_1) | 0;
  };
  protoOf(Counter).toString = function () {
    var tmp;
    if (this instanceof Bit32) {
      tmp = 'Bit32[lo=' + this.o6i_1 + ', hi=' + this.p6i_1 + ', incrementBy=' + this.n6i_1 + ']';
    } else {
      if (this instanceof Bit64) {
        tmp = 'Bit64[lo=' + this.d6j_1.toString() + ', hi=' + this.e6j_1.toString() + ', incrementBy=' + this.c6j_1.toString() + ']';
      } else {
        noWhenBranchMatchedException();
      }
    }
