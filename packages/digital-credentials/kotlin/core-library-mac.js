(function (factory) {
  ...
  protoOf(Engine).hashCode = function () {
    return hashCode(this.o6h_1);
  };
  function Engine() {
    this.o6h_1 = new Object();
  }
  protoOf(Mac).t6f = function () {
    return this.p6h_1;
  };
  protoOf(Mac).r6h = function () {
    var final = this.q6h_1.r6h();
    if (this.q6h_1.n6h_1) {
      this.q6h_1.d6g();
    }
    return final;
  };
  protoOf(Mac).s6h = function (input) {
    this.q6h_1.w6f(input, 0, input.length);
    return this.r6h();
  };
  protoOf(Mac).equals = function (other) {
    var tmp;
    if (other instanceof Mac) {
      tmp = other.q6h_1.equals(this.q6h_1);
    } else {
      tmp = false;
    }
    return tmp;
