(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.g6h_1 = h;
    $this.h6h_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.i6h_1 = h.slice();
    $this.j6h_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).e6g = function (input, offset) {
    ...
    var k = Companion_getInstance().l6h_1;
    var state = this.i6h_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).y6f = function (buf, bufPos) {
    var digest = new Int8Array(this.s6f());
    this.c6g(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).c6g = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.j6h_1.q6g(bufPos).n6g();
    var bitsLo = tmp0_container.cc();
    var bitsHi = tmp0_container.dc();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.e6g(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().z6g(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().z6g(bitsLo, buf, 60);
    this.e6g(buf, 0);
    Big_getInstance();
    var tmp9 = this.i6h_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.s6f() / 4 | 0;
    Big_getInstance().a6h(tmp9, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).z6f = function () {
    fill_0(this.h6h_1, 0);
    var tmp0 = this.g6h_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.i6h_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().m6h_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.m6h_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
