(function (factory) {
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            return this_0.y1z(isInterface(this_2, KSerializer) ? this_2 : THROW_CCE(), tmp1);
          case 2:
            throw this.p9_1;
        }
      } catch ($p) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_3.a6w_1 = tmp0.z1z(isInterface(this_1, KSerializer) ? this_1 : THROW_CCE(), string);
  ...
  protoOf(KeySerialization).serializeKey = function (key) {
    ...
    return this_0.y1z(tmp$ret$1, key);
  };
  ...
  protoOf(KeyUtils).z6x = function (plaintext, headers, keyType) {
    ...
    var tmp$ret$4 = this_1.y1z(tmp$ret$3, appendedHeader);
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_1.e7e_1 = tmp_2.encodeToBase64Url(encodeToByteArray(tmp2.y1z(isInterface(this_2, KSerializer) ? this_2 : THROW_CCE(), value)));
  ...
  protoOf(JWKKeyJsonFieldSerializer).z80 = function (encoder, value) {
    ...
    if (value == null) {
      ...
      var this_2 = serializer(this_1, createKType(getKClass(JsonElement), arrayOf([]), false));
      var tmp$ret$1 = isInterface(this_2, KSerializer) ? this_2 : THROW_CCE();
      tmp_0 = this_0.z1z(tmp$ret$1, value);
    }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            var this_1 = tmp2.v22();
            var this_2 = serializer(this_1, createKType(getKClass(HashMap), arrayOf([createInvariantKTypeProjection(createKType(PrimitiveClasses_getInstance().md(), arrayOf([]), false)), createInvariantKTypeProjection(createKType(getKClass(JsonElement), arrayOf([]), false))]), false));
            tmp_1.p8j_1 = tmp_2.encodeToBase64Url(encodeToByteArray(tmp2.y1z(isInterface(this_2, KSerializer) ? this_2 : THROW_CCE(), value)));
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_0.n95_1 = tmp_1.encodeToBase64Url(encodeToByteArray(tmp2.y1z(isInterface(this_2, KSerializer) ? this_2 : THROW_CCE(), this_0)));
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            tmp_0.r96_1 = tmp1.z1z(isInterface(this_1, KSerializer) ? this_1 : THROW_CCE(), string);
  ...
  protoOf(JwsParts).toString = function () {
    ...
    var tmp$ret$5 = tmp2.y1z(tmp$ret$4, value_0);
